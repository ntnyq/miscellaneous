;(function() {
  ...
  ;(function() {
    ...
    function ca(a, b, c) {
      b.href &&
        ((a = e(a, b.href, void 0 === c ? !1 : c)), ye.test(a) && (b.href = a))
    }
    function l(a, b) {
      if (b && b.action) {
        ...
        if ('get' === c) {
          ...
          d ||
            ((c = He.createElement('input')),
            c.setAttribute('type', 'hidden'),
            c.setAttribute('name', '_gl'),
            c.setAttribute('value', a),
            b.appendChild(c))
        } else
          'post' === c && ((a = e(a, b.action)), ye.test(a) && (b.action = a))
      }
    }
    var k = this,
      w = function(a, b) {
      ...
      Be = function(a, b) {
        He.addEventListener
          ? He.addEventListener(a, b, !1)
          : He.attachEvent && He.attachEvent('on' + a, b)
      },
      Ce = /:[0-9]+$/,
      xe = function(a, b) {
        var c = function(a) {
        ...
        switch (b) {
          case 'protocol':
            ...
            break
          case 'host':
            a = (a.hostname || Ie.location.hostname)
              .replace(Ce, '')
              .toLowerCase()
            break
          case 'port':
            a = String(
              Number(a.hostname ? a.port : Ie.location.port) ||
      ...
      Ke = function(c) {
        ...
        for (var e = '', g = 0; ; ) {
          ...
          64 != l &&
            ((e += String.fromCharCode(((Ee << 4) & 240) | (l >> 2))),
      ...
      Pe = function(a, b, c) {
        ...
        Ie.history &&
          Ie.history.replaceState &&
          (ze.test(b) || ze.test(c)) &&
          ((a = xe(a, 'path')),
          (b = e(b, '?')),
          (c = e(c, '#')),
          Ie.history.replaceState({}, void 0, '' + a + b + c))
      },
      Re = function(a) {
        var b = void 0 === b ? 3 : b
        try {
    ...
    w('google_tag_data.glBridge.auto', function(a, b, c, d) {
      var e = Me()
      e.N ||
        (Be('mousedown', Se), Be('keyup', Se), Be('submit', Je), (e.N = !0))
    ...
    w('google_tag_data.glBridge.get', function(a, b) {
      var c = Oe(!!b)
      b = Me()
      b.data || ((b.data = { query: {}, ea: {} }), c(b.data))
      c = {}
