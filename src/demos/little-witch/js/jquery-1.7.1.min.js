...
;(function(a, b) {
  ...
  var c = a.document,
    ...
    f = (function() {
      ...
      ;(e.fn = e.prototype = {
        ...
        e.each('Boolean Number String Function Array Date RegExp Object'.split(' '), function(
          a,
          b,
        ) {
  ...
  ;(bW = bR.exec(bV.toLowerCase()) || []),
    ...
    f.each('ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend'.split(' '), function(
      a,
      b,
    ) {
      f.fn[b] = function(a) {
