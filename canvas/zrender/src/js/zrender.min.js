!(function(t, e) {
  ...
  function i(t, r, n) {
    if (!g(r) || !g(t)) return n ? e(r) : t
    for (var a in r)
      if (r.hasOwnProperty(a)) {
        var o = t[a],
          s = r[a]
        !g(s) || !g(o) || d(s) || d(o) || m(s) || m(o) || _(s) || _(o) || b(s) || b(o)
          ? (!n && a in t) || (t[a] = e(r[a], !0))
          : i(o, s, n)
      }
    return t
  }
  ...
  function a() {
    return Ar || (Ar = Lr().getContext('2d')), Ar
  }
  function o(t, e) {
    if (t) {
  ...
  function u(t, e, i) {
    if (t && e)
      if (t.forEach && t.forEach === kr) t.forEach(e, i)
  ...
  function c(t, e, i) {
    if (t && e) {
      if (t.map && t.map === Mr) return t.map(e, i)
      for (var r = [], n = 0, a = t.length; n < a; n++) r.push(e.call(i, t[n], n, t))
      return r
    }
  }
  function f(t, e) {
    var i = Cr.call(arguments, 2)
    return function() {
      return t.apply(e, i.concat(Cr.call(arguments)))
    }
  }
  function d(t) {
    return '[object Array]' === wr.call(t)
  }
  function p(t) {
    return 'function' == typeof t
  }
  function v(t) {
    return '[object String]' === wr.call(t)
  }
  function g(t) {
    var e = typeof t
  ...
  function et(t) {
    return K(
      t.length && '%' === t.charAt(t.length - 1) ? (parseFloat(t) / 100) * 255 : parseInt(t, 10),
    )
  }
  function it(t) {
  ...
  function st(t, e) {
    on && ot(on, e), (on = an.put(t, on || e.slice()))
  }
  function ht(t, e) {
    if (t) {
      e = e || []
      ...
      if (r in nn) return ot(e, nn[r]), st(t, e), e
      if ('#' !== r.charAt(0)) {
        var n = r.indexOf('('),
          a = r.indexOf(')')
        if (-1 !== n && a + 1 === r.length) {
          ...
          switch (o) {
            case 'rgba':
              if (4 !== s.length) return void at(e, 0, 0, 0, 1)
              h = it(s.pop())
            case 'rgb':
              return 3 !== s.length
                ? void at(e, 0, 0, 0, 1)
                : (at(e, et(s[0]), et(s[1]), et(s[2]), h), st(t, e), e)
            case 'hsla':
              return 4 !== s.length
                ? void at(e, 0, 0, 0, 1)
                : ((s[3] = it(s[3])), lt(s, e), st(t, e), e)
            case 'hsl':
              return 3 !== s.length ? void at(e, 0, 0, 0, 1) : (lt(s, e), st(t, e), e)
            default:
              return
          }
        }
        ...
        if (4 === r.length)
          return (l = parseInt(r.substr(1), 16)) >= 0 && l <= 4095
            ? (at(
                e,
                ((3840 & l) >> 4) | ((3840 & l) >> 8),
                (240 & l) | ((240 & l) >> 4),
        ...
        if (7 === r.length) {
          ...
          return l >= 0 && l <= 16777215
            ? (at(e, (16711680 & l) >> 16, (65280 & l) >> 8, 255 & l, 1), st(t, e), e)
            : void at(e, 0, 0, 0, 1)
        }
      }
    }
  ...
  function lt(t, e) {
    ...
    return (
      (e = e || []),
      at(e, K(255 * rt(o, a, i + 1 / 3)), K(255 * rt(o, a, i)), K(255 * rt(o, a, i - 1 / 3)), 1),
      4 === t.length && (e[3] = t[3]),
      e
    )
  }
  ...
  function ft(t, e, i) {
    if (e && e.length && t >= 0 && t <= 1) {
      var r = t * (e.length - 1),
        ...
        h = r - n,
        l = dt(
          [K(nt(o[0], s[0], h)), K(nt(o[1], s[1], h)), K(nt(o[2], s[2], h)), tt(nt(o[3], s[3], h))],
          'rgba',
        )
  ...
  function mt(t, e, i, r, n) {
    var a = t.length
    if (1 == n) for (s = 0; s < a; s++) r[s] = gt(t[s], e[s], i)
    else
      for (var o = a && t[0].length, s = 0; s < a; s++)
        for (var h = 0; h < o; h++) r[s][h] = gt(t[s][h], e[s][h], i)
  }
  function yt(t, e, i) {
    var r = t.length,
      n = e.length
    if (r !== n)
      if (r > n) t.length = n
      else for (o = r; o < n; o++) t.push(1 === i ? e[o] : un.call(e[o]))
  ...
  function wt(t, e, i, r, n, a, o, s, h) {
    var l = t.length
    if (1 == h) for (c = 0; c < l; c++) s[c] = bt(t[c], e[c], i[c], r[c], n, a, o)
    else
      for (var u = t[0].length, c = 0; c < l; c++)
        for (var f = 0; f < u; f++) s[c][f] = bt(t[c][f], e[c][f], i[c][f], r[c][f], n, a, o)
  }
  function bt(t, e, i, r, n, a, o) {
    var s = 0.5 * (i - t),
      h = 0.5 * (r - e)
  ...
  function kt(t) {
    if (l(t)) {
      var e = t.length
      if (l(t[0])) {
        for (var i = [], r = 0; r < e; r++) i.push(un.call(t[r]))
        return i
      }
      return un.call(t)
    }
  ...
  function Mt(t, e, i, r, n, a) {
    ...
    if (u) {
      ...
      r.sort(function(t, e) {
        ...
        (c = r[u - 1].time)
      for (var g = [], _ = [], m = r[0].value, y = !0, x = 0; x < u; x++) {
        g.push(r[x].time / c)
        var w = r[x].value
        if (((f && xt(w, m, v)) || (!f && w === m) || (y = !1), (m = w), 'string' == typeof w)) {
          var b = ht(w)
          b ? ((w = b), (d = !0)) : (p = !0)
        }
        _.push(w)
      ...
      if (a || !y) {
        for (var k = _[u - 1], x = 0; x < u - 1; x++)
          f ? yt(_[x], k, v) : !isNaN(_[x]) || isNaN(k) || p || d || (_[x] = k)
        f && yt(o(t._target, n), k, v)
        var T,
          C,
          M,
          P,
        ...
        var B = new $({
          ...
          onframe: function(t, e) {
            ...
            if (e < 0) i = 0
              ...
              for (i = T = Math.min(A + 1, u - 1); i >= 0 && !(g[i] <= e); i--);
              i = Math.min(i, u - 2)
            } else {
              for (i = A; i < u && !(g[i] > e); i++);
              i = Math.min(i - 1, u - 2)
            ...
            if (0 !== r)
              if (((C = (e - g[i]) / r), h))
                if (
                  ...
                  wt(M, P, S, L, C, C * C, C * C * C, o(t, n), v)
                else {
                  if (d) (a = wt(M, P, S, L, C, C * C, C * C * C, R, 1)), (a = Tt(R))
                  else {
                    if (p) return _t(P, S, C)
                    a = bt(M, P, S, L, C, C * C, C * C * C)
                  }
                  s(t, n, a)
                }
              else if (f) mt(_[i], _[i + 1], C, o(t, n), v)
              else {
                var a
                if (d) mt(_[i], _[i + 1], C, R, 1), (a = Tt(R))
                else {
                  if (p) return _t(_[i], _[i + 1], C)
                  a = gt(_[i], _[i + 1], C)
                }
                s(t, n, a)
              }
  ...
  function Dt(t, e) {
    function i(i) {
      ...
      var f = Bt(t[u], t, s, l, 0, e)
      ;(s += f),
        0 !== (l -= f) &&
          0 !== (c = Rt(t[s + l - 1], t, u, c, c - 1, e)) &&
          (l <= c ? r(s, l, u, c) : n(s, l, u, c))
    }
    function r(i, r, n, a) {
      var o = 0
      ...
      if (((t[c--] = t[h--]), 0 != --r))
        if (1 !== a) {
          for (var p = s; ; ) {
            ...
            if (_) break
            do {
              if (0 != (v = r - Bt(l[u], t, i, r, r - 1, e))) {
                for (r -= v, d = (c -= v) + 1, f = (h -= v) + 1, o = v - 1; o >= 0; o--)
                  t[d + o] = t[f + o]
                if (0 === r) {
                  _ = !0
                  break
              ...
              if (0 != (g = a - Rt(t[h], l, 0, a, a - 1, e))) {
                for (a -= g, d = (c -= g) + 1, f = (u -= g) + 1, o = 0; o < g; o++)
                  t[d + o] = l[f + o]
                if (a <= 1) {
                  _ = !0
                  break
  ...
  function Et(t, e, i, r) {
    ...
    if (!(n < 2)) {
      var a = 0
      if (n < bn) return (a = Lt(t, i, r, e)), void zt(t, i, r, i + a, e)
      var o = new Dt(t, e),
        s = St(n)
      do {
        if ((a = Lt(t, i, r, e)) < s) {
          var h = n
          h > s && (h = s), zt(t, i, i + h, i + a, e), (a = h)
        }
      ...
      if ('string' == typeof t) {
        ...
        return (
          a
            ...
            : (!e && (e = new Image()),
              (e.onload = qt),
              Bn.put(t, (e.__cachedImgObj = { image: e, pending: [o] })),
  ...
  function Xt(t, e) {
    ...
    for (var r = (t + '').split('\n'), n = 0, a = 0, o = r.length; a < o; a++)
      n = Math.max(re(r[a], e).width, n)
    return En > In && ((En = 0), (Dn = {})), En++, (Dn[i] = n), n
  }
  function Yt(t, e, i, r, n, a, o) {
    return a ? Gt(t, e, i, r, n, a, o) : Ut(t, e, i, r, n, o)
  }
  function Ut(t, e, i, r, n, a) {
    var o = ne(t, e, n, a),
      s = Xt(t, e)
    n && (s += n[1] + n[3])
    var h = o.outerHeight,
      l = new Pt(Zt(0, s, i), Qt(0, h, r), s, h)
    return (l.lineHeight = o.lineHeight), l
  }
  function Gt(t, e, i, r, n, a, o) {
    var s = ae(t, { rich: a, truncate: o, font: e, textAlign: i, textPadding: n }),
      h = s.outerWidth,
      l = s.outerHeight
    return new Pt(Zt(0, h, i), Qt(0, l, r), h, l)
  }
  function Zt(t, e, i) {
  ...
  function $t(t, e, i) {
    ...
    return { x: r, y: n, textAlign: h, textVerticalAlign: l }
  }
  function Kt(t, e, i, r, n) {
    if (!e) return ''
    var a = (t + '').split('\n')
    n = Jt(e, i, r, n)
    for (var o = 0, s = a.length; o < s; o++) a[o] = te(a[o], n)
    return a.join('\n')
  }
  function Jt(t, e, i, n) {
    ;(n = r({}, n)).font = e
    var i = y(i, '...')
    n.maxIterations = y(n.maxIterations, 2)
    var a = (n.minChar = y(n.minChar, 0))
    n.cnCharWidth = Xt('国', e)
    var o = (n.ascCharWidth = Xt('a', e))
    n.placeholder = y(n.placeholder, '')
  ...
  function te(t, e) {
    ...
    for (var o = 0; ; o++) {
      ...
      var s =
        0 === o
          ? ee(t, n, e.ascCharWidth, e.cnCharWidth)
          : a > 0
          ? Math.floor((t.length * n) / a)
          : 0
      a = Xt((t = t.substr(0, s)), r)
    }
  ...
  function ne(t, e, i, r) {
    ...
    if ((i && (s += i[0] + i[2]), t && r)) {
      ...
      if (null != h && s > h) (t = ''), (a = [])
        ...
        for (
          var u = Jt(l - (i ? i[1] + i[3] : 0), e, r.ellipsis, {
              minChar: r.minChar,
    ...
    return { lines: a, height: o, outerHeight: s, lineHeight: n }
  }
  function ae(t, e) {
    var i = { lines: [], width: 0, height: 0 }
    if ((null != t && (t += ''), !t)) return i
    for (var r, n = (On.lastIndex = 0); null != (r = On.exec(t)); ) {
      var a = r.index
      a > n && oe(i, t.substring(n, a)), oe(i, r[2], r[1]), (n = On.lastIndex)
    }
    n < t.length && oe(i, t.substring(n, t.length))
    var o = i.lines,
      s = 0,
      h = 0,
      l = [],
    ...
    for (A = 0; A < o.length; A++) {
      for (var p = o[A], v = 0, g = 0, _ = 0; _ < p.tokens.length; _++) {
        var m = ((z = p.tokens[_]).styleName && e.rich[z.styleName]) || {},
          w = (z.textPadding = m.textPadding),
          b = (z.font = m.font || e.font),
          k = (z.textHeight = y(m.textHeight, ie(b)))
        if (
          (w && (k += w[0] + w[2]),
          (z.height = k),
          (z.lineHeight = x(m.textLineHeight, e.textLineHeight, k)),
          (z.textAlign = (m && m.textAlign) || e.textAlign),
          (z.textVerticalAlign = (m && m.textVerticalAlign) || 'middle'),
          null != d && s + z.lineHeight > d)
        )
          return { lines: [], width: 0, height: 0 }
        z.textWidth = Xt(z.text, b)
        var T = m.textWidth,
          C = null == T || 'auto' === T
        if ('string' == typeof T && '%' === T.charAt(T.length - 1))
          (z.percentWidth = T), l.push(z), (T = 0)
        else {
          if (C) {
            T = z.textWidth
            var M = m.textBackgroundColor,
              P = M && M.image
            P && jt((P = Vt(P))) && (T = Math.max(T, (P.width * k) / P.height))
          }
          var S = w ? w[1] + w[3] : 0
          T += S
          ...
          null != L &&
            L < T &&
            (!C || L < S
              ? ((z.text = ''), (z.textWidth = T = 0))
              : ((z.text = Kt(z.text, L - S, b, c.ellipsis, { minChar: c.minChar })),
                (z.textWidth = Xt(z.text, b)),
                (T = z.textWidth + S)))
        }
    ...
    ;(i.outerWidth = i.width = y(e.textWidth, h)),
      (i.outerHeight = i.height = y(e.textHeight, s)),
      u && ((i.outerWidth += u[1] + u[3]), (i.outerHeight += u[0] + u[2]))
    for (var A = 0; A < l.length; A++) {
      var z = l[A],
        R = z.percentWidth
      z.width = (parseInt(R, 10) / 100) * h
    }
    return i
  }
  function oe(t, e, i) {
    ...
    h < 0 && ((o += h), (h = -h)),
      ...
      'number' == typeof u
        ...
        ? 1 === u.length
          ...
          : 3 === u.length
          ? ((i = u[0]), (r = a = u[1]), (n = u[2]))
          : ((i = u[0]), (r = u[1]), (n = u[2]), (a = u[3]))
        : (i = r = n = a = 0)
    var c
    i + r > h && ((i *= h / (c = i + r)), (r *= h / c)),
      n + a > h && ((n *= h / (c = n + a)), (a *= h / c)),
      r + n > l && ((r *= l / (c = r + n)), (n *= l / c)),
      i + a > l && ((i *= l / (c = i + a)), (a *= l / c)),
      t.moveTo(o + i, s),
      t.lineTo(o + h - r, s),
      0 !== r && t.quadraticCurveTo(o + h, s, o + h, s + r),
      t.lineTo(o + h, s + l - n),
      0 !== n && t.quadraticCurveTo(o + h, s + l, o + h - n, s + l),
      t.lineTo(o + a, s + l),
  ...
  function le(t) {
    return ue(t), u(t.rich, ue), t
  }
  function ue(t) {
    if (t) {
      t.font = se(t)
      var e = t.textAlign
      'middle' === e && (e = 'center'), (t.textAlign = null == e || Wn[e] ? e : 'left')
      var i = t.textVerticalAlign || t.textBaseline
      'center' === i && (i = 'middle'),
        (t.textVerticalAlign = null == i || Vn[i] ? i : 'top'),
        t.textPadding && (t.textPadding = w(t.textPadding))
    }
  }
  function ce(t, e, i, r, n) {
    r.rich ? de(t, e, i, r, n) : fe(t, e, i, r, n)
  }
  function fe(t, e, i, r, n) {
    var a = we(e, 'font', r.font || Hn),
      o = r.textPadding,
      s = t.__textCotentBlock
    ;(s && !t.__dirty) || (s = t.__textCotentBlock = ne(i, a, o, r.truncate))
    var h = s.outerHeight,
      l = s.lines,
      u = s.lineHeight,
      c = xe(h, r, n),
    ...
    if (y || o) {
      ...
      o && (x += o[1] + o[3])
      var w = Zt(f, x, p)
      y && me(t, e, r, w, g, x, h), o && ((_ = Ce(f, p, o)), (m += o[0]))
    }
    we(e, 'textAlign', p || 'left'),
      we(e, 'textBaseline', 'middle'),
      we(e, 'shadowBlur', r.textShadowBlur || 0),
      we(e, 'shadowColor', r.textShadowColor || 'transparent'),
      we(e, 'shadowOffsetX', r.textShadowOffsetX || 0),
      we(e, 'shadowOffsetY', r.textShadowOffsetY || 0),
      (m += u / 2)
    var b = r.textStrokeWidth,
      k = be(r.textStroke, b),
      T = ke(r.textFill)
    k && (we(e, 'lineWidth', b), we(e, 'strokeStyle', k)), T && we(e, 'fillStyle', T)
    for (var C = 0; C < l.length; C++)
      k && e.strokeText(l[C], _, m), T && e.fillText(l[C], _, m), (m += u)
  }
  function de(t, e, i, r, n) {
    var a = t.__textCotentBlock
    ;(a && !t.__dirty) || (a = t.__textCotentBlock = ae(i, r)), pe(t, e, a, r, n)
  }
    ...
    for (var y = 0; y < i.lines.length; y++) {
      for (
        var x,
          ...
          S = m,
          L = k - 1;
        M < k && (!(x = b[M]).textAlign || 'left' === x.textAlign);

      )
        ge(t, e, x, r, T, _, P, 'left'), (C -= x.width), (P += x.width), M++
      for (; L >= 0 && 'right' === (x = b[L]).textAlign; )
        ge(t, e, x, r, T, _, S, 'right'), (C -= x.width), (S -= x.width), L--
      for (P += (a - (P - g) - (m - S) - C) / 2; M <= L; )
        ge(t, e, (x = b[M]), r, T, _, P + x.width / 2, 'center'), (P += x.width), M++
      _ += T
    }
  }
  ...
  function ge(t, e, i, r, n, a, o, s) {
    var h = r.rich[i.styleName] || {},
      l = i.textVerticalAlign,
      u = a + n / 2
    ...
    var c = i.textPadding
    c && ((o = Ce(o, s, c)), (u -= i.height / 2 - c[2] - i.textHeight / 2)),
      we(e, 'shadowBlur', x(h.textShadowBlur, r.textShadowBlur, 0)),
      we(e, 'shadowColor', h.textShadowColor || r.textShadowColor || 'transparent'),
      we(e, 'shadowOffsetX', x(h.textShadowOffsetX, r.textShadowOffsetX, 0)),
      we(e, 'shadowOffsetY', x(h.textShadowOffsetY, r.textShadowOffsetY, 0)),
      we(e, 'textAlign', s),
      we(e, 'textBaseline', 'middle'),
      we(e, 'font', i.font || Hn)
    var f = be(h.textStroke || r.textStroke, p),
      d = ke(h.textFill || r.textFill),
      p = y(h.textStrokeWidth, r.textStrokeWidth)
    f && (we(e, 'lineWidth', p), we(e, 'strokeStyle', f), e.strokeText(i.text, o, u)),
      d && (we(e, 'fillStyle', d), e.fillText(i.text, o, u))
  }
  function _e(t) {
    return t.textBackgroundColor || (t.textBorderWidth && t.textBorderColor)
  }
  function me(t, e, i, r, n, a, o) {
    var s = i.textBackgroundColor,
      h = i.textBorderWidth,
      l = i.textBorderColor,
      u = v(s)
    if (
      (we(e, 'shadowBlur', i.textBoxShadowBlur || 0),
      we(e, 'shadowColor', i.textBoxShadowColor || 'transparent'),
      we(e, 'shadowOffsetX', i.textBoxShadowOffsetX || 0),
      we(e, 'shadowOffsetY', i.textBoxShadowOffsetY || 0),
      u || (h && l))
    ) {
      e.beginPath()
      var c = i.textBorderRadius
      c ? he(e, { x: r, y: n, width: a, height: o, r: c }) : e.rect(r, n, a, o), e.closePath()
    }
    if (u) we(e, 'fillStyle', s), e.fill()
    else if (g(s)) {
      var f = s.image
      ;(f = Nt(f, null, t, ye, s)) && jt(f) && e.drawImage(f, r, n, a, o)
    }
    h && l && (we(e, 'lineWidth', h), we(e, 'strokeStyle', l), e.stroke())
  }
  function ye(t, e) {
    e.image = t
  }
  function xe(t, e, i) {
    ...
    if (i) {
      ...
      if (s instanceof Array) (r = i.x + Te(s[0], i.width)), (n = i.y + Te(s[1], i.height))
      else {
        var h = $t(s, i, e.textDistance)
        ;(r = h.x), (n = h.y), (a = a || h.textAlign), (o = o || h.textVerticalAlign)
      }
      var l = e.textOffset
      l && ((r += l[0]), (n += l[1]))
    }
    return { baseX: r, baseY: n, textAlign: a, textVerticalAlign: o }
  }
  function we(t, e, i) {
    return (t[e] = i), t[e]
  }
  ...
  function Pe(t) {
    ...
    ;(this.style = new Mn(t.style, this)), (this._rect = null), (this.__clipPaths = [])
  }
  function Se(t) {
    Pe.call(this, t)
  }
  ...
  function Ae(t) {
    return (
      !!t && (!!t.__builtin__ || ('function' == typeof t.resize && 'function' == typeof t.refresh))
    )
  }
  function ze(t) {
    t.__unusedCount++
  ...
  function Be(t, e, i) {
    return (
      jn.copy(t.getBoundingRect()),
      t.transform && jn.applyTransform(t.transform),
      (Xn.width = e),
      (Xn.height = i),
      !jn.intersect(Xn)
    )
  ...
  function He(t, e, i, r) {
    return (
      (i = i || {}),
      r || !mr.canvasSupported
        ? Fe(t, e, i)
        : mr.browser.firefox && null != e.layerX && e.layerX !== e.offsetX
  ...
  function Ve(t, e, i) {
    Un ? t.addEventListener(e, i) : t.attachEvent('on' + e, i)
  }
  function Ne(t, e, i) {
    Un ? t.removeEventListener(e, i) : t.detachEvent('on' + e, i)
  }
  function qe(t) {
    var e = t[1][0] - t[0][0],
      i = t[1][1] - t[0][1]
  ...
  function Xe(t) {
    return 'mousewheel' === t && mr.browser.firefox ? 'DOMMouseScroll' : t
  }
  function Ye(t, e, i) {
    var r = t._gestureMgr
    'start' === i && r.clear()
  ...
  function Ze(t) {
    ...
    u(Jn, function(e) {
      t._handlers[e] = f(ia[e], t)
    }),
      u(ea, function(e) {
        t._handlers[e] = f(ia[e], t)
      }),
      u(Kn, function(i) {
        t._handlers[i] = e(ia[i], t)
      })
  }
  function Qe(t) {
    function e(e, i) {
    ...
    Wr.call(this),
      ...
      (this._touching = !1),
      this._touchTimer,
      (this._gestureMgr = new Qn()),
      (this._handlers = {}),
      Ze(this),
      mr.pointerEventsSupported
        ? e(ea, this)
        : (mr.touchEventsSupported && e(Jn, this), e(Kn, this))
  }
  function $e(t, e) {
    aa[t] = e
  }
  ...
  function ri(t, e, i, r, n, a) {
    var o = r + 3 * (e - i) - t,
      ...
      f = h * h - 3 * s * l,
      d = 0
    if (Je(u) && Je(c)) Je(s) ? (a[0] = 0) : (T = -h / s) >= 0 && T <= 1 && (a[d++] = T)
    else {
      var p = c * c - 4 * u * f
      if (Je(p)) {
        var v = c / u,
        ...
        var _ = la(p),
          ...
          y = u * s + 1.5 * o * (-c - _)
        ;(T =
          (-s - ((m = m < 0 ? -ha(-m, da) : ha(m, da)) + (y = y < 0 ? -ha(-y, da) : ha(y, da)))) /
          (3 * o)) >= 0 &&
          T <= 1 &&
          (a[d++] = T)
      } else {
        var x = (2 * u * s - 3 * o * c) / (2 * la(u * u * u)),
          w = Math.acos(x) / 3,
          b = la(u),
          k = Math.cos(w),
          T = (-s - 2 * b * k) / (3 * o),
          g = (-s + b * (k + fa * Math.sin(w))) / (3 * o),
          C = (-s + b * (k - fa * Math.sin(w))) / (3 * o)
        T >= 0 && T <= 1 && (a[d++] = T),
          g >= 0 && g <= 1 && (a[d++] = g),
          C >= 0 && C <= 1 && (a[d++] = C)
      }
  ...
  function ni(t, e, i, r, n) {
    var a = 6 * i - 12 * e + 6 * t,
      ...
      s = 3 * e - 3 * t,
      h = 0
    if (Je(o)) ti(a) && (c = -s / a) >= 0 && c <= 1 && (n[h++] = c)
    else {
      var l = a * a - 4 * o * s
      if (Je(l)) n[0] = -a / (2 * o)
      else if (l > 0) {
  ...
  function oi(t, e, i, r, n, a, o, s, h, l, u) {
    ...
    for (var m = 0; m < 1; m += 0.05)
      (va[0] = ei(t, i, n, o, m)),
        (va[1] = ei(e, r, a, s, m)),
        (p = Or(pa, va)) < _ && ((c = m), (_ = p))
    _ = 1 / 0
    for (var y = 0; y < 32 && !(g < ca); y++)
      (f = c - g),
        (d = c + g),
        (va[0] = ei(t, i, n, o, f)),
        (va[1] = ei(e, r, a, s, f)),
        ...
        f >= 0 && p < _
          ...
          : ((ga[0] = ei(t, i, n, o, d)),
            (ga[1] = ei(e, r, a, s, d)),
            (v = Or(ga, pa)),
            d <= 1 && v < _ ? ((c = d), (_ = v)) : (g *= 0.5))
    return u && ((u[0] = ei(t, i, n, o, c)), (u[1] = ei(e, r, a, s, c))), la(_)
  }
  function si(t, e, i, r) {
    var n = 1 - r
  ...
  function li(t, e, i, r, n) {
    var a = t - 2 * e + i,
      ...
      s = t - r,
      h = 0
    if (Je(a)) ti(o) && (c = -s / o) >= 0 && c <= 1 && (n[h++] = c)
    else {
      var l = o * o - 4 * a * s
      if (Je(l)) (c = -o / (2 * a)) >= 0 && c <= 1 && (n[h++] = c)
      else if (l > 0) {
        var u = la(l),
          c = (-o + u) / (2 * a),
          f = (-o - u) / (2 * a)
  ...
  function fi(t, e, i, r, n, a, o, s, h) {
    ...
    for (var f = 0; f < 1; f += 0.05)
      (va[0] = si(t, i, n, f)), (va[1] = si(e, r, a, f)), (g = Or(pa, va)) < c && ((l = f), (c = g))
    c = 1 / 0
    for (var d = 0; d < 32 && !(u < ca); d++) {
      var p = l - u,
        v = l + u
      ;(va[0] = si(t, i, n, p)), (va[1] = si(e, r, a, p))
      var g = Or(va, pa)
      if (p >= 0 && g < c) (l = p), (c = g)
      else {
        ;(ga[0] = si(t, i, n, v)), (ga[1] = si(e, r, a, v))
        var _ = Or(ga, pa)
        v <= 1 && _ < c ? ((l = v), (c = _)) : (u *= 0.5)
      }
    }
    return h && ((h[0] = si(t, i, n, l)), (h[1] = si(e, r, a, l))), la(c)
  }
  function di(t, e, i, r, n, a) {
    ;(n[0] = _a(t, i)), (n[1] = _a(e, r)), (a[0] = ma(t, i)), (a[1] = ma(e, r))
  }
  function pi(t, e, i, r, n, a, o, s, h, l) {
    ...
    for (h[0] = 1 / 0, h[1] = 1 / 0, l[0] = -1 / 0, l[1] = -1 / 0, u = 0; u < d; u++) {
      var p = f(t, i, n, o, Ca[u])
      ;(h[0] = _a(p, h[0])), (l[0] = ma(p, l[0]))
    }
    for (d = c(e, r, a, s, Ma), u = 0; u < d; u++) {
      var v = f(e, r, a, s, Ma[u])
      ;(h[1] = _a(v, h[1])), (l[1] = ma(v, l[1]))
    }
    ;(h[0] = _a(t, h[0])),
      (l[0] = ma(t, l[0])),
      (h[0] = _a(o, h[0])),
  ...
  function vi(t, e, i, r, n, a, o, s) {
    var h = ui,
      ...
      f = l(t, i, n, u),
      d = l(e, r, a, c)
    ;(o[0] = _a(t, n, f)), (o[1] = _a(e, a, d)), (s[0] = ma(t, n, f)), (s[1] = ma(e, a, d))
  }
  function gi(t, e, i, r, n, a, o, s, h) {
    var l = E,
      ...
      c = Math.abs(n - a)
    if (c % wa < 1e-4 && c > 1e-4)
      return (s[0] = t - i), (s[1] = e - r), (h[0] = t + i), void (h[1] = e + r)
    if (
      ((ba[0] = xa(n) * i + t),
      (ba[1] = ya(n) * r + e),
      (ka[0] = xa(a) * i + t),
    ...
    for (var d = 0; d < a; d += Math.PI / 2)
      d > n && ((Ta[0] = xa(d) * i + t), (Ta[1] = ya(d) * r + e), l(s, Ta, s), u(h, Ta, h))
  }
  ...
  function mi(t, e, i, r, n, a, o, s, h, l, u) {
    ...
    return (
      !(
        ...
        (l < t - c && l < i - c && l < n - c && l < o - c)
      ) && oi(t, e, i, r, n, a, o, s, l, u, null) <= c / 2
    )
  }
  function yi(t, e, i, r, n, a, o, s, h) {
    ...
    return (
      !(
        ...
        (s > t + l && s > i + l && s > n + l) ||
        (s < t - l && s < i - l && s < n - l)
      ) && fi(t, e, i, r, n, a, s, h, null) <= l / 2
    )
  }
  function xi(t) {
    return (t %= Wa) < 0 && (t += Wa), t
  }
  function wi(t, e, i, r, n, a, o, s, h) {
    ...
    if (Math.abs(r - n) % Va < 1e-4) return !0
    if (a) {
      var c = r
      ;(r = xi(n)), (n = xi(c))
    } else (r = xi(r)), (n = xi(n))
    ...
    return f < 0 && (f += Va), (f >= r && f <= n) || (f + Va >= r && f + Va <= n)
  }
  function bi(t, e, i, r, n, a) {
    ...
    var o = r < e ? 1 : -1,
      s = (a - e) / (r - e)
    return (1 !== s && 0 !== s) || (o = r < e ? 0.5 : -0.5), s * (i - t) + t > n ? o : 0
  }
  function ki(t, e) {
    return Math.abs(t - e) < ja
  }
  function Ti() {
    var t = Ya[0]
    ;(Ya[0] = Ya[1]), (Ya[1] = t)
  }
  function Ci(t, e, i, r, n, a, o, s, h, l) {
    if ((l > e && l > r && l > a && l > s) || (l < e && l < r && l < a && l < s)) return 0
    var u = ri(e, r, a, s, l, Xa)
    if (0 === u) return 0
  ...
  function Mi(t, e, i, r, n, a, o, s) {
    ...
    if (l >= 0 && l <= 1) {
      for (var u = 0, c = si(e, r, a, l), f = 0; f < h; f++) {
        d = 0 === Xa[f] || 1 === Xa[f] ? 0.5 : 1
        ;(p = si(t, i, n, Xa[f])) < o || (Xa[f] < l ? (u += c < e ? d : -d) : (u += a < c ? d : -d))
      }
      return u
    }
    var d = 0 === Xa[0] || 1 === Xa[0] ? 0.5 : 1,
      p = si(t, i, n, Xa[0])
    return p < o ? 0 : a < e ? d : -d
  }
  function Pi(t, e, i, r, n, a, o, s) {
    ...
    for (var u = 0, c = 0; c < 2; c++) {
      ...
      if (f + t > o) {
        var d = Math.atan2(s, f),
          p = a ? 1 : -1
        d < 0 && (d = qa + d),
          ((d >= r && d <= n) || (d + qa >= r && d + qa <= n)) &&
            (d > Math.PI / 2 && d < 1.5 * Math.PI && (p = -p), (u += p))
      }
    }
    return u
  }
  function Si(t, e, i, r, n) {
    for (var a = 0, o = 0, s = 0, h = 0, l = 0, u = 0; u < t.length; ) {
      var c = t[u++]
      switch (
        (c === Na.M && u > 1 && (i || (a += bi(o, s, h, l, r, n))),
        ...
        case Na.C:
          ...
          } else a += Ci(o, s, t[u++], t[u++], t[u++], t[u++], t[u], t[u + 1], r, n) || 0
          ;(o = t[u++]), (s = t[u++])
          break
        case Na.Q:
          if (i) {
            if (yi(o, s, t[u++], t[u++], t[u], t[u + 1], e, r, n)) return !0
          } else a += Mi(o, s, t[u++], t[u++], t[u], t[u + 1], r, n) || 0
          ;(o = t[u++]), (s = t[u++])
          break
        case Na.A:
          var f = t[u++],
  ...
  function Ri(t, e, i, r, n, a, o, s, h, l, u) {
    var c = h * (ao / 180),
      f = (no(c) * (t - i)) / 2 + (ro(c) * (e - r)) / 2,
      d = (-1 * ro(c) * (t - i)) / 2 + (no(c) * (e - r)) / 2,
      p = (f * f) / (o * o) + (d * d) / (s * s)
    p > 1 && ((o *= io(p)), (s *= io(p)))
    var v =
        (n === a ? -1 : 1) *
      ...
      g = (v * o * d) / s,
      _ = (v * -s * f) / o,
      m = (t + i) / 2 + no(c) * g - ro(c) * _,
      y = (e + r) / 2 + ro(c) * g + no(c) * _,
      x = ho([1, 0], [(f - g) / o, (d - _) / s]),
      w = [(f - g) / o, (d - _) / s],
      b = [(-1 * f - g) / o, (-1 * d - _) / s],
      k = ho(w, b)
    so(w, b) <= -1 && (k = ao),
  ...
  function Bi(t) {
    ...
    var e,
      i = t
        ...
        .replace(/ /g, ',')
        .replace(/,,/g, ',')
    for (e = 0; e < eo.length; e++) i = i.replace(new RegExp(eo[e], 'g'), '|' + eo[e])
    var r,
      n = i.split('|'),
      a = 0,
      o = 0,
    ...
    for (e = 1; e < n.length; e++) {
      ...
      for (; f < d.length && !isNaN(d[f]) && !isNaN(d[0]); ) {
        ...
        switch (c) {
          ...
          case 'C':
            ;(l = h.C),
              s.addData(l, d[f++], d[f++], d[f++], d[f++], d[f++], d[f++]),
              (a = d[f - 2]),
              (o = d[f - 1])
            break
          case 'c':
            ;(l = h.C),
              s.addData(l, d[f++] + a, d[f++] + o, d[f++] + a, d[f++] + o, d[f++] + a, d[f++] + o),
              (a += d[f - 2]),
              (o += d[f - 1])
            break
          case 'S':
            ...
            var T = s.len(),
              C = s.data
            r === h.C && ((v += a - C[T - 4]), (g += o - C[T - 3])),
              (l = h.C),
              (b = d[f++]),
              (k = d[f++]),
              (a = d[f++]),
              (o = d[f++]),
              s.addData(l, v, g, b, k, a, o)
            break
          case 's':
            ;(v = a), (g = o)
            var T = s.len(),
          ...
          case 'A':
            ;(_ = d[f++]),
              ...
              (x = d[f++]),
              (w = d[f++]),
              Ri((b = a), (k = o), (a = d[f++]), (o = d[f++]), x, w, _, m, y, (l = h.A), s)
            break
          case 'a':
            ;(_ = d[f++]),
              (m = d[f++]),
  ...
  function Ei(t, e, i) {
    ...
    return null === r || null === n
      ? [(i ? ii : ei)(t.x1, t.cpx1, t.cpx2, t.x2, e), (i ? ii : ei)(t.y1, t.cpy1, t.cpy2, t.y2, e)]
      : [(i ? hi : si)(t.x1, t.cpx1, t.x2, e), (i ? hi : si)(t.y1, t.cpy1, t.y2, e)]
  }
  function Ii(t, e, i, r, n, a, o) {
    var s = 0.5 * (i - t),
      h = 0.5 * (r - e)
    return (2 * (e - i) + s + h) * o + (-3 * (e - i) - 2 * s - h) * a + s * n + e
  }
  function Oi(t, e, i) {
    ...
    if (r && r.length >= 2) {
      if (n && 'spline' !== n) {
        var a = Mo(r, n, i, e.smoothConstraint)
        ...
        'spline' === n && (r = Co(r, i)), t.moveTo(r[0][0], r[0][1])
  ...
  function Hi(t) {
    return document.createElementNS(Uo, t)
  }
  function Fi(t) {
    return $o(1e4 * t) / 1e4
  }
  ...
  function qi(t, e) {
    e && ji(t, 'transform', 'matrix(' + Zo.call(e, ',') + ')')
  }
  function ji(t, e, i) {
  ...
  function Yi(t, e, i) {
    if (Vi(e, i)) {
      ...
      ;(r = 'transparent' === r ? Qo : r),
        'none' !== t.getAttribute('clip-path') && r === Qo && (r = 'rgba(0, 0, 0, 0.002)'),
        ji(t, 'fill', r),
        ji(t, 'fill-opacity', e.opacity)
    } else ji(t, 'fill', Qo)
    if (Ni(e, i)) {
      var n = i ? e.textStroke : e.stroke
      ji(t, 'stroke', (n = 'transparent' === n ? Qo : n)),
        ji(
          t,
          'stroke-width',
          (i ? e.textStrokeWidth : e.lineWidth) / (e.strokeNoScale ? e.host.getLineScale() : 1),
        ),
        ji(t, 'paint-order', 'stroke'),
        ji(t, 'stroke-opacity', e.opacity),
        e.lineDash
          ? (ji(t, 'stroke-dasharray', e.lineDash.join(',')),
            ji(t, 'stroke-dashoffset', $o(e.lineDashOffset || 0)))
          : ji(t, 'stroke-dasharray', ''),
        e.lineCap && ji(t, 'stroke-linecap', e.lineCap),
        e.lineJoin && ji(t, 'stroke-linejoin', e.lineJoin),
        e.miterLimit && ji(t, 'stroke-miterlimit', e.miterLimit)
    } else ji(t, 'stroke', Qo)
  }
  function Ui(t) {
    for (var e = [], i = t.data, r = t.len(), n = 0; n < r; ) {
      ...
      switch (i[n++]) {
        ...
        case Go.A:
          var s = i[n++],
            ...
            g = Wi(v % es) && !Wi(v),
            _ = !1
          _ = v >= es || (!Wi(v) && ((f > -ts && f < 0) || f > ts) == !!p)
          var m = Fi(s + l * Jo(c)),
            y = Fi(h + u * Ko(c))
          g && ((f = p ? es - 1e-4 : 1e-4 - es), (_ = !0), 9 === n && e.push('M', m, y))
          var x = Fi(s + l * Jo(c + f)),
            w = Fi(h + u * Ko(c + f))
          e.push('A', Fi(l), Fi(u), $o(d * is), +_, +p, x, w)
          break
        case Go.Z:
          a = 'Z'
          break
      ...
      a && e.push(a)
      for (var T = 0; T < o; T++) e.push(Fi(i[n++]))
    }
    return e.join(' ')
  }
  function Gi(t) {
  ...
  function Ji(t) {
    Ki.call(this, t, ['linearGradient', 'radialGradient'], '__gradient_in_use__')
  }
  function tr(t) {
    Ki.call(this, t, 'clipPath', '__clippath_in_use__')
  }
  function er(t) {
    return parseInt(t, 10)
  }
  function ir(t) {
    return t instanceof zi ? ns : t instanceof Se ? as : t instanceof co ? os : ns
  }
  function rr(t, e) {
  ...
  function lr(t) {
    return function() {
      vn('In SVG mode painter not support method "' + t + '"')
    }
  }
  function ur(t) {
    return fs(t)
  ...
  function cr() {
    if (!vs && gs) {
      vs = !0
      var t = gs.styleSheets
      t.length < 31
        ? gs.createStyleSheet().addRule('.zrvml', 'behavior:url(#default#VML)')
  ...
  function pr(t) {
    return function() {
      vn('In IE8.0 VML mode painter not support method "' + t + '"')
    }
  }
  var vr = 2311,
    gr = function() {
    ...
    mr = (_r =
      'undefined' == typeof navigator
        ? { browser: {}, os: {}, node: !0, canvasSupported: !0, svgSupported: !0 }
        : (function(t) {
            var e = {},
              i = t.match(/Firefox\/([\d.]+)/),
    ...
    Sr = {},
    Lr = function() {
      return Sr.createCanvas()
    }
  Sr.createCanvas = function() {
  ...
  k.prototype = {
    ...
    each: function(t, e) {
      void 0 !== e && (t = f(t, e))
      for (var i in this) this.hasOwnProperty(i) && t(this[i], i.slice(4))
    },
  ...
  var Rr = (Object.freeze || Object)({
      ...
      reduce: function(t, e, i, r) {
        if (t && e) {
          if (t.reduce && t.reduce === Pr) return t.reduce(e, i, r)
      ...
      filter: function(t, e, i) {
        if (t && e) {
          if (t.filter && t.filter === Tr) return t.filter(e, i)
      ...
      bind: f,
      curry: function(t) {
        var e = Cr.call(arguments, 1)
        return function() {
          return t.apply(this, e.concat(Cr.call(arguments)))
        }
      },
      isArray: d,
      isFunction: p,
      ...
      retrieve3: x,
      slice: function() {
        return Function.call.apply(Cr, arguments)
      },
      normalizeCssArray: w,
      assert: function(t, e) {
    ...
    Br = 'undefined' == typeof Float32Array ? Array : Float32Array,
    Dr = S,
    Er = L,
    Ir = R,
    Or = B,
  ...
  O.prototype = {
    ...
    _dragStart: function(t) {
      ...
      e &&
        ...
        (this._x = t.offsetX),
        (this._y = t.offsetY),
        this.dispatchToElement(H(e, t), 'dragstart', t.event))
    },
    _drag: function(t) {
      ...
      if (e) {
        ...
        ;(this._x = i),
          (this._y = r),
          e.drift(n, a, t),
          this.dispatchToElement(H(e, t), 'drag', t.event)
        var o = this.findHover(i, r, e).target,
          s = this._dropTarget
        ;(this._dropTarget = o),
          e !== o &&
            (s && o !== s && this.dispatchToElement(H(s, t), 'dragleave', t.event),
            o && o !== s && this.dispatchToElement(H(o, t), 'dragenter', t.event))
      }
    },
    _dragEnd: function(t) {
      var e = this._draggingTarget
      e && (e.dragging = !1),
        this.dispatchToElement(H(e, t), 'dragend', t.event),
        this._dropTarget && this.dispatchToElement(H(this._dropTarget, t), 'drop', t.event),
  ...
  ;(qr.prototype = {
    ...
    findHover: function(t, e, i) {
      for (
        ...
        if (
          ...
          !r[a].ignore &&
          (o = V(r[a], t, e)) &&
          (!n.topTarget && (n.topTarget = r[a]), o !== Vr)
        ) {
          n.target = r[a]
          break
        }
    ...
    h(qr, Wr),
    h(qr, O)
  var jr = 'undefined' == typeof Float32Array ? Array : Float32Array,
    ...
    Zr = Gr.prototype
  ;(Zr.transform = null),
    (Zr.needLocalTransform = function() {
      return (
        Q(this.rotation) ||
        Q(this.position[0]) ||
        Q(this.position[1]) ||
    ...
    (Zr.updateTransform = function() {
      ...
      i || e
        ? ((r = r || N()),
          i ? this.getLocalTransform(r) : Yr(r),
          e && (i ? X(r, t.transform, r) : j(r, t.transform)),
          (this.transform = r),
          (this.invTransform = this.invTransform || N()),
          Z(this.invTransform, r))
        : r && Yr(r)
    }),
    (Zr.getLocalTransform = function(t) {
      return Gr.getLocalTransform(this, t)
    }),
    (Zr.setTransform = function(t) {
    ...
    (Zr.restoreTransform = function(t) {
      var e = t.dpr || 1
      t.setTransform(e, 0, 0, e, 0, 0)
    })
  var Qr = []
  ;(Zr.decomposeTransform = function() {
    if (this.transform) {
      var t = this.parent,
        e = this.transform
      t && t.transform && (X(Qr, t.invTransform, e), (e = Qr))
      ...
      Q(i - 1) && (i = Math.sqrt(i)),
        ...
        (a[0] = i),
        (a[1] = r),
        (this.rotation = Math.atan2(-e[1] / r, e[0] / i))
    }
  }),
    (Zr.getGlobalScale = function() {
    ...
    (Zr.transformCoordToLocal = function(t, e) {
      var i = [t, e],
        r = this.invTransform
      return r && D(i, i, r), i
    }),
    (Zr.transformCoordToGlobal = function(t, e) {
      var i = [t, e],
        r = this.transform
      return r && D(i, i, r), i
    }),
    (Gr.getLocalTransform = function(t, e) {
      Yr((e = e || []))
      var i = t.origin,
        r = t.scale || [1, 1],
        n = t.rotation || 0,
  ...
  var Kr = function() {
    ...
    Jr = Kr.prototype
  ;(Jr.insert = function(t) {
    var e = new tn(t)
    return this.insertEntry(e), e
  }),
    (Jr.insertEntry = function(t) {
      this.head
    ...
    ln = (Object.freeze || Object)({
      ...
      lift: function(t, e) {
        ...
        if (i) {
          ...
          return dt(i, 4 === i.length ? 'rgba' : 'rgb')
        }
      },
      toHex: function(t) {
        var e = ht(t)
      ...
      modifyAlpha: function(t, e) {
        if ((t = ht(t)) && null != e) return (t[3] = tt(e)), dt(t, 'rgba')
      },
      stringify: dt,
    }),
      ...
      for (var r in e)
        if (e.hasOwnProperty(r)) {
          if (!i[r]) {
            ...
            if (null == n) continue
            0 !== t && i[r].push({ time: 0, value: kt(n) })
          }
  ...
  var fn = 1
  'undefined' != typeof window && (fn = Math.max(window.devicePixelRatio || 1, 1))
  var dn = fn,
    pn = function() {},
    vn = pn,
    gn = function() {
  ...
  gn.prototype = {
    ...
    animate: function(t, e) {
      ...
      vn('Property "' + t + '" is not existed in element ' + n.id)
    },
    ...
    _animateToShallow: function(t, e, i, r, n) {
      ...
      for (var s in i)
        if (i.hasOwnProperty(s))
          if (null != e[s])
            g(i[s]) && !l(i[s])
              ? this._animateToShallow(t ? t + '.' + s : s, e[s], i[s], r, n)
              : ((a[s] = i[s]), o++)
          else if (null != i[s])
            if (t) {
              var h = {}
  ...
  var _n = function(t) {
    Gr.call(this, t), Wr.call(this, t), gn.call(this, t), (this.id = t.id || gr())
  }
  ;(_n.prototype = {
    type: 'element',
    name: '',
    ...
    attr: function(t, e) {
      ...
      else if (g(t)) for (var i in t) t.hasOwnProperty(i) && this.attrKV(i, t[i])
  ...
  ;(Pt.prototype = {
    ...
    union: function(t) {
      var e = yn(t.x, this.x),
        i = yn(t.y, this.y)
      ;(this.width = xn(t.x + t.width, this.x + this.width) - e),
        (this.height = xn(t.y + t.height, this.y + this.height) - i),
        (this.x = e),
        (this.y = i)
    },
      ...
      return function(n) {
        if (n) {
          ;(t[0] = i[0] = this.x),
            ...
            mn(i, i, n),
            mn(r, r, n),
            (this.x = yn(t[0], e[0], i[0], r[0])),
            (this.y = yn(t[1], e[1], i[1], r[1]))
          var a = xn(t[0], e[0], i[0], r[0]),
            o = xn(t[1], e[1], i[1], r[1])
    ...
    calculateTransform: function(t) {
      var e = this,
        ...
        r = t.height / e.height,
        n = N()
      return Y(n, n, [-e.x, -e.y]), G(n, n, [i, r]), Y(n, n, [t.x, t.y]), n
    },
    intersect: function(t) {
      if (!t) return !1
      t instanceof Pt || (t = Pt.create(t))
      var e = this,
        i = e.x,
        r = e.x + e.width,
        n = e.y,
    ...
    (Pt.create = function(t) {
      return new Pt(t.x, t.y, t.width, t.height)
    })
  var wn = function(t) {
    ;(t = t || {}), _n.call(this, t)
  ...
  ;(wn.prototype = {
    ...
    _doAdd: function(t) {
      ...
      var e = this.__storage,
        i = this.__zr
      e && e !== t.__storage && (e.addToStorage(t), t instanceof wn && t.addChildrenToStorage(e)),
        i && i.refresh()
    },
    remove: function(t) {
      var e = this.__zr,
      ...
      return n < 0
        ...
        : (r.splice(n, 1),
          (t.parent = null),
          i && (i.delFromStorage(t), t instanceof wn && t.delChildrenFromStorage(i)),
          e && e.refresh(),
          this)
    },
    removeAll: function() {
      ...
      for (e = 0; e < i.length; e++)
        (t = i[e]),
          r && (r.delFromStorage(t), t instanceof wn && t.delChildrenFromStorage(r)),
          (t.parent = null)
    ...
    addChildrenToStorage: function(t) {
      for (var e = 0; e < this._children.length; e++) {
        ...
        t.addToStorage(i), i instanceof wn && i.addChildrenToStorage(t)
      }
    },
    delChildrenFromStorage: function(t) {
      for (var e = 0; e < this._children.length; e++) {
        var i = this._children[e]
        t.delFromStorage(i), i instanceof wn && i.delChildrenFromStorage(t)
      }
    },
    dirty: function() {
    ...
    getBoundingRect: function(t) {
      for (
        var e = null, i = new Pt(0, 0, 0, 0), r = t || this._children, n = [], a = 0;
        a < r.length;
        a++
      ) {
        var o = r[a]
        if (!o.ignore && !o.invisible) {
          ...
          h
            ? (i.copy(s), i.applyTransform(h), (e = e || i.clone()).union(i))
            : (e = e || s.clone()).union(s)
        }
      }
      return e || i
  ...
  Tn.prototype = {
    ...
    updateDisplayList: function(t) {
      ...
      for (var e = this._roots, i = this._displayList, r = 0, n = e.length; r < n; r++)
        this._updateAndAddDisplayable(e[r], null, t)
      ;(i.length = this._displayListLen), mr.canvasSupported && Et(i, It)
    },
    ...
    addRoot: function(t) {
      t.__storage !== this &&
        (t instanceof wn && t.addChildrenToStorage(this), this.addToStorage(t), this._roots.push(t))
    },
    delRoot: function(t) {
      if (null == t) {
        for (i = 0; i < this._roots.length; i++) {
          var e = this._roots[i]
          e instanceof wn && e.delChildrenFromStorage(this)
        }
        return (this._roots = []), (this._displayList = []), void (this._displayListLen = 0)
      }
      if (t instanceof Array) for (var i = 0, r = t.length; i < r; i++) this.delRoot(t[i])
      else {
        var n = o(this._roots, t)
        n >= 0 &&
          (this.delFromStorage(t),
          this._roots.splice(n, 1),
          t instanceof wn && t.delChildrenFromStorage(this))
      }
    },
  ...
  Mn.prototype = {
    ...
    blend: null,
    bind: function(t, e, i) {
      for (var r = this, n = i && i.style, a = !n, o = 0; o < Cn.length; o++) {
        var s = Cn[o],
          h = s[0]
        ;(a || r[h] !== n[h]) && (t[h] = r[h] || s[1])
      }
      if (
    ...
    getGradient: function(t, e, i) {
      for (
        var r = ('radial' === e.type ? Ht : Ot)(t, e, i), n = e.colorStops, a = 0;
        a < n.length;
        a++
      )
  ...
  for (var Pn = Mn.prototype, Sn = 0; Sn < Cn.length; Sn++) {
    var Ln = Cn[Sn]
    Ln[0] in Pn || (Pn[Ln[0]] = Ln[1])
  }
  Mn.getGradient = Pn.getGradient
  var An = function(t, e) {
    ;(this.image = t), (this.repeat = e), (this.type = 'pattern')
  }
  An.prototype.getCanvasPattern = function(t) {
    return t.createPattern(this.image, this.repeat || 'repeat')
  }
  var zn = function(t, e, i) {
    var r
    ;(i = i || dn),
      'string' == typeof t ? (r = Wt(t, e, i)) : g(t) && (t = (r = t).id),
      (this.id = t),
      (this.dom = r)
    var n = r.style
    n &&
  ...
  zn.prototype = {
    ...
    createBackBuffer: function() {
      var t = this.dpr
      ;(this.domBack = Wt('back-' + this.id, this.painter, t)),
    ...
    clear: function(t) {
      ...
      if (
        (o &&
          ...
          this.ctxBack.drawImage(e, 0, 0, r / h, n / h)),
        i.clearRect(0, 0, r, n),
        a)
      ) {
        var l
        a.colorStops
          ? ((l = a.__canvasGradient || Mn.getGradient(i, a, { x: 0, y: 0, width: r, height: n })),
            (a.__canvasGradient = l))
          : a.image && (l = An.prototype.getCanvasPattern.call(a, i)),
          i.save(),
          (i.fillStyle = l || a),
          i.fillRect(0, 0, r, n),
          i.restore()
      ...
      if (o) {
        var u = this.domBack
        i.save(), (i.globalAlpha = s), i.drawImage(u, 0, 0, r, n), i.restore()
      }
    },
  }
  var Rn =
  ...
  Fn.measureText = function(t, e) {
    var i = a()
    return (i.font = e || Hn), i.measureText(t)
  }
  var Wn = { left: 1, right: 1, center: 1 },
    Vn = { top: 1, bottom: 1, middle: 1 },
    Nn = new Pt(),
    qn = function() {}
  ;(qn.prototype = {
    constructor: qn,
    drawRectText: function(t, e) {
      var i = this.style
      ;(e = i.textRect || e), this.__dirty && le(i)
      var r = i.text
      if ((null != r && (r += ''), Me(r, i))) {
        t.save()
        var n = this.transform
        i.transformText ? this.setTransform(t) : n && (Nn.copy(e), Nn.applyTransform(n), (e = Nn)),
          ce(this, t, r, i, e),
          t.restore()
      }
    },
    ...
    (Pe.prototype = {
      ...
      attrKV: function(t, e) {
        'style' !== t ? _n.prototype.attrKV.call(this, t, e) : this.style.set(e)
      },
      setStyle: function(t, e) {
        return this.style.set(t, e), this.dirty(!1), this
      },
      useStyle: function(t) {
        return (this.style = new Mn(t, this)), this.dirty(!1), this
      },
    }),
    s(Pe, _n),
    h(Pe, qn),
    (Se.prototype = {
      ...
      brush: function(t, e) {
        var i = this.style,
          r = i.image
        i.bind(t, this, e)
        var n = (this._image = Nt(r, this._image, this, this.onload))
        if (n && jt(n)) {
          var a = i.x || 0,
            o = i.y || 0,
            s = i.width,
          ...
          if (
            (null == s && null != h
              ...
              : null == h && null != s
              ? (h = s / l)
              : null == s && null == h && ((s = n.width), (h = n.height)),
            this.setTransform(t),
            i.sWidth && i.sHeight)
          ) {
            var u = i.sx || 0,
      ...
      getBoundingRect: function() {
        var t = this.style
        return (
          this._rect || (this._rect = new Pt(t.x || 0, t.y || 0, t.width || 0, t.height || 0)),
          this._rect
        )
      },
    }),
    s(Se, Pe)
  var jn = new Pt(0, 0, 0, 0),
    Xn = new Pt(0, 0, 0, 0),
    Yn = function(t, e, i) {
      this.type = 'canvas'
      var n = !t.nodeName || 'CANVAS' === t.nodeName.toUpperCase()
      ;(this._opts = i = r({}, i || {})),
        (this.dpr = i.devicePixelRatio || dn),
      ...
      if (((this._layerConfig = {}), n)) {
        ...
        var h = t.width,
          l = t.height
        ;(this._width = h), (this._height = l)
        var u = new zn(t, this, 1)
        u.initContext(), (s[0] = u), o.push(0), (this._domRoot = t)
      } else {
        ;(this._width = this._getSize(0)), (this._height = this._getSize(1))
        var c = (this._domRoot = Ie(this._width, this._height))
        t.appendChild(c)
      }
  ...
  Yn.prototype = {
    ...
    refreshHover: function() {
      var t = this._hoverElements,
        ...
        i = this._hoverlayer
      if ((i && i.clear(), e)) {
        Et(t, this.storage.displayableSortFunc), i || (i = this._hoverlayer = this.getLayer(1e5))
        var r = {}
        i.ctx.save()
        for (var n = 0; n < e; ) {
          var a = t[n],
    ...
    _startProgessive: function() {
      function t() {
        i === e._progressiveToken &&
          e.storage &&
          (e._doPaintList(e.storage.getDisplayList()),
          e._furtherProgressive ? (e._progress++, Rn(t)) : (e._progressiveToken = -1))
      }
      var e = this
    ...
    _clearProgressive: function() {
      ;(this._progressiveToken = -1),
        (this._progress = 0),
        u(this._progressiveLayers, function(t) {
          t.__dirty && t.clear()
        })
    },
    _paintList: function(t, e) {
      null == e && (e = !1),
        ...
        this.eachBuiltinLayer(ze),
        this._doPaintList(t, e),
        this.eachBuiltinLayer(Re)
    },
      ...
      for (
        ...
        if (
          ...
          n !== _ &&
            ...
            (o = {}),
            (n = _),
            (r = this.getLayer(n)).__builtin__ ||
              vn('ZLevel ' + n + ' has been used by unkown layer ' + r.id),
            (a = r.ctx).save(),
            (r.__unusedCount = 0),
            (r.__dirty || e) && r.clear()),
          r.__dirty || e)
          ...
          if (m >= 0) {
            if (!s) {
              if (
                ((s = this._progressiveLayers[Math.min(l++, 4)]).ctx.save(),
                (s.renderScope = {}),
              ...
              ;(h = s.__progress), s.__dirty || (d = h), (s.__progress = d + 1)
            }
            m === d && this._doPaintEl(g, s, !0, s.renderScope)
          } else this._doPaintEl(g, r, e, o)
          g.__dirty = !1
        }
      }
      s && i(s),
    ...
    _doPaintEl: function(t, e, i, r) {
      ...
      if (
        ...
        0 !== t.style.opacity &&
        (!a || a[0] || a[3]) &&
        (!t.culling || !Be(t, this._width, this._height))
      ) {
        var o = t.__clipPaths
        ;(r.prevClipLayer !== e || De(o, r.prevElClipPaths)) &&
          (r.prevElClipPaths &&
            (r.prevClipLayer.ctx.restore(),
            (r.prevClipLayer = r.prevElClipPaths = null),
            (r.prevEl = null)),
          o && (n.save(), Ee(o, n), (r.prevClipLayer = e), (r.prevElClipPaths = o))),
    ...
    getLayer: function(t) {
      ...
      return (
        e ||
          (((e = new zn('zr_' + t, this, this.dpr)).__builtin__ = !0),
    ...
    insertLayer: function(t, e) {
      var i = this._layers,
        ...
        o = -1,
        s = this._domRoot
      if (i[t]) vn('ZLevel ' + t + ' has been used already')
      else if (Ae(e)) {
        if (n > 0 && t > r[0]) {
      ...
      } else vn('Layer of zlevel ' + t + ' is not valid')
    },
    ...
    _updateLayerStatus: function(t) {
      ...
      for (var a, o, s = 0, h = 0, l = 0, c = t.length; l < c; l++) {
        var f = t[l],
          d = e[this._singleCanvas ? 0 : f.zlevel],
          p = f.progressive
        if ((d && (d.elCount++, (d.__dirty = d.__dirty || f.__dirty)), p >= 0)) {
          o !== p && ((o = p), h++)
          var v = (f.__frame = h - 1)
          if (!a) {
            var g = Math.min(s, 4)
            ;(a = i[g]) || (a = i[g] = new zn('progressive', this, this.dpr)).initContext(),
              (a.__maxProgress = 0)
          }
          ;(a.__dirty = a.__dirty || f.__dirty),
            a.elCount++,
            (a.__maxProgress = Math.max(a.__maxProgress, v)),
            a.__maxProgress >= a.__progress && (d.__dirty = !0)
        } else (f.__frame = -1), a && ((a.__nextIdxNotProg = l), s++, (a = null))
      }
      a && (s++, (a.__nextIdxNotProg = l)),
        this.eachBuiltinLayer(function(t, e) {
    ...
    getRenderedCanvas: function(t) {
      function e(t, e) {
        ...
        for (var n, a = 0; a < r.length; a++) {
          var s = r[a],
            h = o._layers[s]
          if (!h.__builtin__ && s > t && s < e) {
            n = h
            break
          }
        }
        n && n.renderToCanvas && (i.ctx.save(), n.renderToCanvas(i.ctx), i.ctx.restore())
      }
      if (((t = t || {}), this._singleCanvas)) return this._layers[0].dom
      var i = new zn('image', this, t.pixelRatio || this.dpr)
      i.initContext(), (i.clearColor = t.backgroundColor), i.clear()
      for (var r, n = this.storage.getDisplayList(!0), a = {}, o = this, s = 0; s < n.length; s++) {
        var h = n[s]
        h.zlevel !== r && (e(r, h.zlevel), (r = h.zlevel)), this._doPaintEl(h, i, !0, a)
      }
      return e(r, 1 / 0), i.dom
    },
    getWidth: function() {
      return this._width
    },
    ...
    _getSize: function(t) {
      ...
      return ((o[r] || Le(s[i]) || Le(o.style[i])) - (Le(s[n]) || 0) - (Le(s[a]) || 0)) | 0
    },
    pathToImage: function(t, e) {
      ...
      var g = { position: t.position, rotation: t.rotation, scale: t.scale }
      ;(t.position = [u - n.x, f - n.y]),
        (t.rotation = 0),
        (t.scale = [1, 1]),
        t.updateTransform(),
        t && t.brush(r)
      var _ = new Se({ style: { x: 0, y: 0, image: i } })
      return (
  ...
  var Un = 'undefined' != typeof window && !!window.addEventListener,
  ...
  ;(Zn.prototype = {
    ...
    _startLoop: function() {
      function t() {
        e._running && (Rn(t), !e._paused && e._update())
      }
      var e = this
      ;(this._running = !0), Rn(t)
    },
    start: function() {
    ...
    animate: function(t, e) {
      var i = new cn(t, (e = e || {}).loop, e.getter, e.setter)
  ...
  Qn.prototype = {
    ...
    _doTrack: function(t, e, i) {
      ...
      if (r) {
        for (
          var n = { points: [], touches: [], target: e, event: t }, a = 0, o = r.length;
          a < o;
          a++
        ) {
          var s = r[a],
  ...
  var $n = {
      pinch: function(t, e) {
        ...
        if (i) {
          ...
          if (n && n.length > 1 && r && r.length > 1) {
            ...
            var o = je(r)
            return (
              (e.pinchX = o[0]), (e.pinchY = o[1]), { type: 'pinch', target: t[0].target, event: e }
            )
          }
        }
      },
    ...
    Jn = ['touchstart', 'touchend', 'touchmove'],
    ta = { pointerdown: 1, pointerup: 1, pointermove: 1, pointerout: 1 },
    ea = c(Kn, function(t) {
    ...
    ia = {
      ...
      touchstart: function(t) {
        ;((t = We(this.dom, t)).zrByTouch = !0),
          (this._lastTouchMoment = new Date()),
          Ye(this, t, 'start'),
          ia.mousemove.call(this, t),
          ia.mousedown.call(this, t),
          Ue(this)
      },
      ...
      touchend: function(t) {
        ;((t = We(this.dom, t)).zrByTouch = !0),
          Ye(this, t, 'end'),
          ia.mouseup.call(this, t),
          +new Date() - this._lastTouchMoment < 300 && ia.click.call(this, t),
          Ue(this)
      },
      ...
      pointermove: function(t) {
        Ge(t) || ia.mousemove.call(this, t)
      },
      pointerup: function(t) {
        ia.mouseup.call(this, t)
      },
      pointerout: function(t) {
        Ge(t) || ia.mouseout.call(this, t)
      },
    }
  u(['click', 'mousedown', 'mouseup', 'mousewheel', 'dblclick', 'contextmenu'], function(t) {
    ia[t] = function(e) {
  ...
  var ra = Qe.prototype
  ;(ra.dispose = function() {
    for (var t = Kn.concat(Jn), e = 0; e < t.length; e++) {
      var i = t[e]
      Ne(this.dom, Xe(i), this._handlers[i])
    }
  }),
    (ra.setCursor = function(t) {
      this.dom.style.cursor = t || 'default'
    }),
    h(Qe, Wr)
  var na = !mr.canvasSupported,
    aa = { canvas: Yn },
    oa = {},
    sa = function(t, e, i) {
      ...
      var r = this,
        ...
        a = i.renderer
      if (na) {
        if (!aa.vml) throw new Error("You need to require 'zrender/vml/vml' to support IE8")
        a = 'vml'
      } else (a && aa[a]) || (a = 'canvas')
      var o = new aa[a](e, n, i)
      ;(this.storage = n), (this.painter = o)
      var s = mr.node ? null : new Qe(o.getViewportRoot())
      ;(this.handler = new qr(n, o, s, o.root)),
        (this.animation = new Zn({ stage: { update: f(this.flush, this) } })),
  ...
  var ha = Math.pow,
    ...
    Ca = [],
    Ma = [],
    Pa = { M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7 },
    Sa = [],
    La = [],
    Aa = [],
    za = [],
    ...
    Ia = Math.sqrt,
    Oa = Math.abs,
    Ha = 'undefined' != typeof Float32Array,
    Fa = function(t) {
  ...
  ;(Fa.prototype = {
    ...
    setScale: function(t, e) {
      ;(this._ux = Oa(1 / dn / t) || 0), (this._uy = Oa(1 / dn / e) || 0)
    },
    getContext: function() {
      return this._ctx
    },
    ...
    arc: function(t, e, i, r, n, a) {
      return (
        this.addData(Pa.A, t, e, i, i, r, n - r, 0, a ? 0 : 1),
    ...
    rect: function(t, e, i, r) {
      return this._ctx && this._ctx.rect(t, e, i, r), this.addData(Pa.R, t, e, i, r), this
    },
    closePath: function() {
      this.addData(Pa.Z)
      var t = this._ctx,
    ...
    setData: function(t) {
      var e = t.length
      ;(this.data && this.data.length == e) || !Ha || (this.data = new Float32Array(e))
    ...
    appendPath: function(t) {
      ...
      Ha && this.data instanceof Float32Array && (this.data = new Float32Array(r + i))
      for (n = 0; n < e; n++)
    ...
    _dashedLineTo: function(t, e) {
      var i,
        ...
        v = o.length
      for (
        u /= f, c /= f, a < 0 && (a = n + a), d -= (a %= n) * u, p -= a * c;
        (u > 0 && d <= t) ||
        (u < 0 && d >= t) ||
        (0 == u && ((c > 0 && p <= e) || (c < 0 && p >= e)));
      ...
      ;(u = d - t), (c = p - e), (this._dashOffset = -Ia(u * u + c * c))
    },
    _dashedBezierTo: function(t, e, i, r, n, a) {
      ...
      for (o = (w - f) / m; o <= 1; )
        (l = _(v, t, i, n, o)),
          (u = _(g, e, r, a, o)),
          y % 2 ? p.moveTo(l, u) : p.lineTo(l, u),
          (o += d[y] / m),
          (y = (y + 1) % x)
      y % 2 != 0 && p.lineTo(n, a),
        (s = n - l),
        (h = a - u),
        (this._dashOffset = -Ia(s * s + h * h))
    },
    ...
    toStatic: function() {
      var t = this.data
      t instanceof Array && ((t.length = this._len), Ha && (this.data = new Float32Array(t)))
    },
    getBoundingRect: function() {
      ;(Sa[0] = Sa[1] = Aa[0] = Aa[1] = Number.MAX_VALUE),
        (La[0] = La[1] = za[0] = za[1] = -Number.MAX_VALUE)
      for (var t = this.data, e = 0, i = 0, r = 0, n = 0, a = 0; a < t.length; ) {
        var o = t[a++]
        switch ((1 == a && ((r = e = t[a]), (n = i = t[a + 1])), o)) {
          case Pa.M:
            ;(e = r = t[a++]), (i = n = t[a++]), (Aa[0] = r), (Aa[1] = n), (za[0] = r), (za[1] = n)
            break
          case Pa.L:
            di(e, i, t[a], t[a + 1], Aa, za), (e = t[a++]), (i = t[a++])
            break
          case Pa.C:
            pi(e, i, t[a++], t[a++], t[a++], t[a++], t[a], t[a + 1], Aa, za),
              (e = t[a++]),
              (i = t[a++])
            break
          case Pa.Q:
            vi(e, i, t[a++], t[a++], t[a], t[a + 1], Aa, za), (e = t[a++]), (i = t[a++])
            break
          case Pa.A:
            var s = t[a++],
              h = t[a++],
              ...
              f = t[a++] + c,
              d = (t[a++], 1 - t[a++])
            1 == a && ((r = Da(c) * l + s), (n = Ea(c) * u + h)),
              gi(s, h, l, u, c, f, d, Aa, za),
              (e = Da(f) * l + s),
              (i = Ea(f) * u + h)
            break
          case Pa.R:
            di((r = e = t[a++]), (n = i = t[a++]), r + t[a++], n + t[a++], Aa, za)
            break
          case Pa.Z:
            ;(e = r), (i = n)
        }
        E(Sa, Sa, Aa), I(La, La, za)
      }
      return (
        0 === a && (Sa[0] = Sa[1] = La[0] = La[1] = 0),
        new Pt(Sa[0], Sa[1], La[0] - Sa[0], La[1] - Sa[1])
      )
    },
    rebuildPath: function(t) {
      for (
        var e, i, r, n, a, o, s = this.data, h = this._ux, l = this._uy, u = this._len, c = 0;
        c < u;
        ...
        switch ((1 == c && ((e = r = s[c]), (i = n = s[c + 1])), f)) {
          ...
          case Pa.L:
            ;(a = s[c++]),
              (o = s[c++]),
              (Oa(a - r) > h || Oa(o - n) > l || c === u - 1) && (t.lineTo(a, o), (r = a), (n = o))
            break
          case Pa.C:
  ...
  var Wa = 2 * Math.PI,
    ...
    Xa = [-1, -1, -1],
    Ya = [-1, -1],
    Ua = An.prototype.getCanvasPattern,
    Ga = Math.abs,
    Za = new Fa(!0)
  ;(zi.prototype = {
    constructor: zi,
    ...
    brush: function(t, e) {
      ...
      h ? (t.fillStyle = this._fillGradient) : u && (t.fillStyle = Ua.call(o, t)),
        l ? (t.strokeStyle = this._strokeGradient) : c && (t.strokeStyle = Ua.call(s, t))
      var d = i.lineDash,
        p = i.lineDashOffset,
        v = !!t.setLineDash,
        g = this.getGlobalScale()
      r.setScale(g[0], g[1]),
        this.__dirtyPath || (d && !v && n)
          ? (r.beginPath(t),
            d && !v && (r.setLineDash(d), r.setLineDashOffset(p)),
            this.buildPath(r, this.shape, !1),
            this.path && (this.__dirtyPath = !1))
          : (t.beginPath(), this.path.rebuildPath(t)),
        a && r.fill(t),
        d && v && (t.setLineDash(d), (t.lineDashOffset = p)),
        n && r.stroke(t),
        d && v && t.setLineDash([]),
      ...
      if (((this._rect = t), e.hasStroke())) {
        ...
        if (this.__dirty || i) {
          ...
          e.hasFill() || (a = Math.max(a, this.strokeContainThreshold || 4)),
            o > 1e-10 &&
              ((n.width += a / o), (n.height += a / o), (n.x -= a / o / 2), (n.y -= a / o / 2))
        }
        return n
      }
      return t
    ...
    contain: function(t, e) {
      ...
      if (((t = i[0]), (e = i[1]), r.contain(t, e))) {
        ...
        if (n.hasStroke()) {
          ...
          if (
            s > 1e-10 &&
            (n.hasFill() || (o = Math.max(o, this.strokeContainThreshold)), Ai(a, o / s, t, e))
          )
            return !0
        }
    ...
    attrKV: function(t, e) {
      'shape' === t
        ...
        : Pe.prototype.attrKV.call(this, t, e)
    },
    setShape: function(t, e) {
      var i = this.shape
      if (i) {
        if (g(t)) for (var r in t) t.hasOwnProperty(r) && (i[r] = t[r])
        else i[t] = e
        this.dirty(!0)
      }
      return this
    ...
    getLineScale: function() {
      var t = this.transform
      return t && Ga(t[0] - 1) > 1e-10 && Ga(t[3] - 1) > 1e-10
        ? Math.sqrt(Ga(t[0] * t[3] - t[2] * t[1]))
        : 1
    },
  }),
  ...
  var Qa = Fa.CMD,
      ...
      for (n = 0, a = 0; n < h.length; ) {
        switch (((i = h[n++]), (a = n), (r = 0), i)) {
          ...
          case d:
            var v = e[4],
              g = e[5],
              _ = Ka(e[0] * e[0] + e[1] * e[1]),
              m = Ka(e[2] * e[2] + e[3] * e[3]),
              y = Ja(-e[1] / m, e[0] / _)
            ;(h[n] *= _),
              (h[n++] += v),
              (h[n] *= m),
        ...
        for (o = 0; o < r; o++)
          ((s = $a[o])[0] = h[n++]), (s[1] = h[n++]), D(s, s, e), (h[a++] = s[0]), (h[a++] = s[1])
      }
    },
    eo = [
      'm',
    ...
    so = function(t, e) {
      return (t[0] * e[0] + t[1] * e[1]) / (oo(t) * oo(e))
    },
    ho = function(t, e) {
      return (t[0] * e[1] < t[1] * e[0] ? -1 : 1) * Math.acos(so(t, e))
    },
    lo = (Object.freeze || Object)({
      createFromString: function(t, e) {
        return new zi(Di(t, e))
      },
      extendFromString: function(t, e) {
        return zi.extend(Di(t, e))
      },
  ...
  ;(co.prototype = {
    ...
    brush: function(t, e) {
      ...
      null != r && (r += ''),
        i.bind(t, this, e),
        Me(r, i) && (this.setTransform(t), ce(this, t, r, i), this.restoreTransform(t))
    },
    getBoundingRect: function() {
      var t = this.style
      if ((this.__dirty && le(t), !this._rect)) {
        var e = t.text
        null != e ? (e += '') : (e = '')
        var i = Yt(t.text + '', t.font, t.textAlign, t.textVerticalAlign, t.textPadding, t.rich)
        if (((i.x += t.x || 0), (i.y += t.y || 0), be(t.textStroke, t.textStrokeWidth))) {
  ...
  var fo = zi.extend({
    ...
    _o = zi.extend({
      ...
      buildPath: function(t, e) {
        var i = e.cx,
          ...
          a = e.height
        t.moveTo(i, r + n),
          t.bezierCurveTo(i + n, r + n, i + (3 * n) / 2, r - n / 3, i, r - a),
          t.bezierCurveTo(i - (3 * n) / 2, r - n / 3, i - n, r + n, i, r + n),
          t.closePath()
      },
    }),
    mo = zi.extend({
    ...
    yo = zi.extend({
      ...
      buildPath: function(t, e) {
        var i = e.cx,
          ...
          a = e.height
        t.moveTo(i, r),
          t.bezierCurveTo(i + n / 2, r - (2 * a) / 3, i + 2 * n, r + a / 3, i, r + a),
      ...
      buildPath: function(t, e) {
        ...
        if (i && !(i < 2)) {
          var r = e.x,
            ...
            o = (2 * xo) / i,
            s = -xo / 2
          t.moveTo(r + a * bo(s), n + a * wo(s))
          for (var h = 0, l = i - 1; h < l; h++) (s += o), t.lineTo(r + a * bo(s), n + a * wo(s))
          t.closePath()
        }
      },
    }),
    ...
    Co = function(t, e) {
      for (var i = t.length, r = [], n = 0, a = 1; a < i; a++) n += R(t[a - 1], t[a])
      var o = n / 2
      o = o < i ? i : o
      for (a = 0; a < o; a++) {
        var s,
          ...
          d = t[c % i]
        e
          ? ((s = t[(c - 1 + i) % i]), (h = t[(c + 1) % i]), (l = t[(c + 2) % i]))
          : ((s = t[0 === c ? c : c - 1]),
            (h = t[c > i - 2 ? i - 1 : c + 1]),
            (l = t[c > i - 3 ? i - 1 : c + 2]))
        var p = f * f,
          v = f * p
        r.push([Ii(s[0], d[0], h[0], l[0], f, p, v), Ii(s[1], d[1], h[1], l[1], f, p, v)])
      }
      return r
    },
    Mo = function(t, e, i, r) {
      ...
      if (r) {
        ;(o = [1 / 0, 1 / 0]), (s = [-1 / 0, -1 / 0])
        for (var f = 0, d = t.length; f < d; f++) E(o, o, t[f]), I(s, s, t[f])
        E(o, o, r[0]), I(s, s, r[1])
      }
      for (var f = 0, d = t.length; f < d; f++) {
        ...
        var v = R(p, n),
          g = R(p, a),
          _ = v + g
        0 !== _ && ((v /= _), (g /= _)), A(u, l, -v), A(c, l, g)
        var m = M([], p, u),
          y = M([], p, c)
        r && (I(m, m, o), E(m, m, s), I(y, y, o), E(y, y, s)), h.push(m), h.push(y)
      }
    ...
    Lo = zi.extend({
      ...
      buildPath: function(t, e) {
        var i = e.x,
          ...
          n = e.width,
          a = e.height
        e.r ? he(t, e) : t.rect(i, r, n, a), t.closePath()
      },
    }),
    Ao = zi.extend({
      type: 'ring',
      ...
      buildPath: function(t, e) {
        ...
        for (var u = 0, c = a.length; u < c; u++) {
          ...
          for (var f = 0; f <= 360 * s; f++)
            (i = n * zo((((o / s) * f) % 360) * Bo) * Ro(f * Bo) + h),
              (r = n * zo((((o / s) * f) % 360) * Bo) * zo(f * Bo) + l),
              t.lineTo(i, r)
        }
      },
    }),
    Eo = [['shadowBlur', 0], ['shadowColor', '#000'], ['shadowOffsetX', 0], ['shadowOffsetY', 0]],
    Io = zi.extend({
      type: 'sector',
      shape: { cx: 0, cy: 0, r0: 0, r: 0, startAngle: 0, endAngle: 2 * Math.PI, clockwise: !0 },
      brush: (function(t) {
        return mr.browser.ie && mr.browser.version >= 11
          ? function() {
              var e,
                i = this.__clipPaths,
                r = this.style
              if (i)
                for (var n = 0; n < i.length; n++) {
                  ...
                  if (
                    ...
                    for (h = 0; h < Eo.length; h++)
                      (Eo[h][2] = r[Eo[h][0]]), (r[Eo[h][0]] = Eo[h][1])
                    e = !0
                    break
                  }
                }
              if ((t.apply(this, arguments), e))
                for (var h = 0; h < Eo.length; h++) r[Eo[h][0]] = Eo[h][2]
            }
          : t
      })(zi.prototype.brush),
      buildPath: function(t, e) {
      ...
      buildPath: function(t, e) {
        ...
        if (i && !(i < 2)) {
          var r = e.cx,
            ...
            a = e.r,
            o = e.r0
          null == o && (o = i > 4 ? (a * Ho((2 * Oo) / i)) / Ho(Oo / i) : a / 3)
          var s = Oo / i,
            h = -Oo / 2,
            l = r + a * Ho(h),
            u = n + a * Fo(h)
          ...
          for (var c, f = 0, d = 2 * i - 1; f < d; f++)
            (c = f % 2 == 0 ? o : a), t.lineTo(r + c * Ho(h), n + c * Fo(h)), (h += s)
          t.closePath()
        }
      },
    }),
      ...
      buildPath: function(t, e) {
        ...
        if (!(e.location && o <= s)) {
          var f,
            d = 0,
            p = 1
          ;(i = (o + c * s) * Vo(0) - c * h * Vo(0) + l),
            (r = (o + c * s) * No(0) - h * No(0) + u),
            t.moveTo(i, r)
          do {
            d++
          } while ((s * d) % (o + c * s) != 0)
          do {
            ;(f = (Math.PI / 180) * p),
              (n = (o + c * s) * Vo(f) - c * h * Vo((o / s + c) * f) + l),
              (a = (o + c * s) * No(f) - h * No((o / s + c) * f) + u),
              t.lineTo(n, a),
              p++
  ...
  ;(Xo.prototype = { constructor: Xo }), s(Xo, jo)
  ...
  ;(Yo.prototype = { constructor: Yo }), s(Yo, jo)
  var Uo = 'http://www.w3.org/2000/svg',
    Go = Fa.CMD,
    Zo = Array.prototype.join,
    Qo = 'none',
    $o = Math.round,
    Ko = Math.sin,
    Jo = Math.cos,
  ...
  ns.brush = function(t) {
    var e = t.style,
      i = t.__svgEl
    i || ((i = Hi('path')), (t.__svgEl = i)), t.path || t.createPathProxy()
    var r = t.path
    if (t.__dirtyPath) {
      r.beginPath(), t.buildPath(r, t.shape), (t.__dirtyPath = !1)
      var n = Ui(r)
      n.indexOf('NaN') < 0 && ji(i, 'd', n)
    }
    Yi(i, e), qi(i, t.transform), null != e.text && hs(t, t.getBoundingRect())
  }
  var as = {}
  as.brush = function(t) {
    var e = t.style,
    ...
    if ((i instanceof HTMLImageElement && (i = i.src), i)) {
      var r = e.x || 0,
        ...
        o = e.height,
        s = t.__svgEl
      s || ((s = Hi('image')), (t.__svgEl = s)),
        i !== t.__imageSrc && (Xi(s, 'href', i), (t.__imageSrc = i)),
        ji(s, 'width', a),
        ji(s, 'height', o),
        ji(s, 'x', r),
        ji(s, 'y', n),
        qi(s, t.transform),
        null != e.text && hs(t, t.getBoundingRect())
    }
  }
  var os = {},
    ss = new Pt(),
    hs = function(t, e, i) {
      ...
      if (null != n) {
        ...
        var a = t.__textSvgEl
        if (
          (a || ((a = Hi('text')), (t.__textSvgEl = a)),
          Yi(a, r, !0),
          t instanceof co || t.style.transformText)
        )
          qi(a, t.transform)
        else if (t.transform) ss.copy(e), ss.applyTransform(t.transform), (e = ss)
        else {
          var o = t.transformCoordToGlobal(e.x, e.y)
          ;(e.x = o[0]), (e.y = o[1])
        }
        var s,
          h,
        ...
        var f =
            r.font ||
            [r.fontStyle || '', r.fontWeight || '', r.fontSize || '', r.fontFamily || ''].join(
              ' ',
            ) ||
            Hn,
          d = Gi(r.textVerticalAlign),
          p = (i = Yt(n, f, c, d)).lineHeight
        if (l instanceof Array) (s = e.x + l[0]), (h = e.y + l[1])
        else {
          var v = $t(l, e, u)
          ;(s = v.x), (h = v.y), (d = Gi(v.textVerticalAlign)), (c = v.textAlign)
        }
        ji(a, 'alignment-baseline', d), f && (a.style.font = f)
        var g = r.textPadding
        ji(a, 'x', s), ji(a, 'y', h)
        var _ = n.split('\n'),
          m = _.length,
        ...
        'left' === y
          ...
          : 'right' === y
          ? ((y = 'end'), g && (s -= g[1]))
          : 'center' === y && ((y = 'middle'), g && (s += (g[3] - g[1]) / 2))
        var x = 0
        if (
          ('baseline' === d
            ? ((x = -i.height + p), g && (x -= g[2]))
            : 'middle' === d
            ? ((x = (-i.height + p) / 2), g && (h += (g[0] - g[2]) / 2))
            : g && (x += g[0]),
          t.__text !== n || t.__textFont !== f)
        ) {
          var w = t.__tspanList || []
          t.__tspanList = w
          for (k = 0; k < m; k++)
            (T = w[k])
              ...
              : ((T = w[k] = Hi('tspan')),
                a.appendChild(T),
                ji(T, 'alignment-baseline', d),
                ji(T, 'text-anchor', y)),
              ji(T, 'x', s),
              ji(T, 'y', h + k * p + x),
              T.appendChild(document.createTextNode(_[k]))
          for (; k < w.length; k++) a.removeChild(w[k])
          ;(w.length = m), (t.__text = n), (t.__textFont = f)
        } else if (t.__tspanList.length)
          for (var b = t.__tspanList.length, k = 0; k < b; ++k) {
            var T = t.__tspanList[k]
            T && (ji(T, 'x', s), ji(T, 'y', h + k * p + x))
          }
      }
    }
  ;(os.drawRectText = hs),
    (os.brush = function(t) {
      ...
      null != e.text &&
        ((e.textPosition = [0, 0]),
        hs(t, { x: e.x || 0, y: e.y || 0, width: 0, height: 0 }, t.getBoundingRect()))
    }),
    (Zi.prototype = {
      diff: function(t, e, i) {
        i ||
        ...
        for (; o <= s; ) {
          var f = (function() {
            for (var i = -1 * o; i <= o; i += 2) {
              ...
              if (f || d) {
                if (
                  (!f || (d && l.newPos < u.newPos)
                    ? ((s = $i(u)), r.pushComponent(s.components, void 0, !0))
                    : ((s = l).newPos++, r.pushComponent(s.components, !0, void 0)),
                  (c = r.extractCommon(s, e, t, i)),
                  s.newPos + 1 >= n && c + 1 >= a)
                )
                  return Qi(0, s.components)
                h[i] = s
              } else h[i] = void 0
            }
            o++
  ...
  var ls = new Zi(),
    us = function(t, e, i) {
      return ls.diff(t, e, i)
    }
  ;(Ki.prototype.createElement = Hi),
    (Ki.prototype.getDefs = function(t) {
      var e = this._svgRoot,
    ...
    (Ki.prototype.update = function(t, e) {
      if (t) {
        var i = this.getDefs(!1)
        if (t._dom && i.contains(t._dom)) 'function' == typeof e && e()
        else {
          var r = this.add(t)
          r && (t._dom = r)
        }
    ...
    (Ki.prototype.addDom = function(t) {
      this.getDefs(!0).appendChild(t)
    }),
    (Ki.prototype.removeDom = function(t) {
      this.getDefs(!1).removeChild(t._dom)
    }),
    (Ki.prototype.getDoms = function() {
      var t = this.getDefs(!1)
      if (!t) return []
      var e = []
      return (
        u(this._tagNames, function(i) {
    ...
    (Ki.prototype.markAllUnused = function() {
      var t = this
      u(this.getDoms(), function(e) {
        e[t._markLabel] = '0'
      })
    }),
    (Ki.prototype.markUsed = function(t) {
      t && (t[this._markLabel] = '1')
    }),
    (Ki.prototype.removeUnused = function() {
      var t = this.getDefs(!1)
      if (t) {
        var e = this
    ...
    (Ki.prototype.getSvgProxy = function(t) {
      return t instanceof zi ? ns : t instanceof Se ? as : t instanceof co ? os : ns
    }),
    (Ki.prototype.getTextSvgElement = function(t) {
      return t.__textSvgEl
    }),
    (Ki.prototype.getSvgElement = function(t) {
      return t.__svgEl
    }),
    s(Ji, Ki),
    (Ji.prototype.addWithoutUpdate = function(t, e) {
      if (e && e.style) {
        var i = this
    ...
    (Ji.prototype.add = function(t) {
      ...
      if ('linear' === t.type) e = this.createElement('linearGradient')
        ...
        if ('radial' !== t.type) return vn('Illegal gradient type.'), null
    ...
    (Ji.prototype.update = function(t) {
      var e = this
      Ki.prototype.update.call(this, t, function() {
        var i = t.type,
          r = t._dom.tagName
    ...
    (Ji.prototype.updateDom = function(t, e) {
      if ('linear' === t.type)
        ...
        if ('radial' !== t.type) return void vn('Illegal gradient type.')
      ...
      for (var i = t.colorStops, r = 0, n = i.length; r < n; ++r) {
        ...
        a.setAttribute('offset', 100 * i[r].offset + '%'),
          a.setAttribute('stop-color', i[r].color),
          e.appendChild(a)
      }
      t._dom = e
    }),
    (Ji.prototype.markUsed = function(t) {
      if (t.style) {
        var e = t.style.fill
        e && e._dom && Ki.prototype.markUsed.call(this, e._dom),
          (e = t.style.stroke) && e._dom && Ki.prototype.markUsed.call(this, e._dom)
      }
    }),
    s(tr, Ki),
    ...
    (tr.prototype.updateDom = function(t, e, i) {
      if (e && e.length > 0) {
        var r,
          n,
          a = this.getDefs(!0),
          ...
          s = i ? '_textDom' : '_dom'
        o[s]
          ? ((n = o[s].getAttribute('id')), (r = o[s]), a.contains(r) || a.appendChild(r))
          : ((n = 'zr-clip-' + this.nextId),
            ++this.nextId,
        ...
        if (o.transform && o.parent.invTransform && !i) {
          ...
          X(o.transform, o.parent.invTransform, o.transform), h.brush(o), (o.transform = l)
        } else h.brush(o)
    ...
    (tr.prototype.markUsed = function(t) {
      ...
      t.__clipPaths &&
        ...
        u(t.__clipPaths, function(t) {
          t._dom && Ki.prototype.markUsed.call(e, t._dom),
            t._textDom && Ki.prototype.markUsed.call(e, t._textDom)
        })
    })
  var cs = function(t, e, i) {
    ...
    n.setAttribute('xmlns', 'http://www.w3.org/2000/svg'),
      ...
      (this.gradientManager = new Ji(n)),
      (this.clipPathManager = new tr(n))
  ...
  ;(cs.prototype = {
    ...
    _paintList: function(t) {
      ...
      for (e = 0; e < n; e++) {
        ...
        d.invisible ||
          (d.__dirty &&
            (o && o.brush(d),
            this.clipPathManager.update(d),
            d.style &&
              (this.gradientManager.update(d.style.fill),
              this.gradientManager.update(d.style.stroke)),
            (d.__dirty = !1)),
          a.push(d))
      }
      var s,
      ...
      for (e = 0; e < h.length; e++) {
        ...
        if (c.added)
          for (f = 0; f < c.count; f++) {
            var l = hr((d = a[c.indices[f]])),
              u = sr(d)
            s ? nr(i, l, s) : ar(i, l),
              l ? nr(i, u, l) : s ? nr(i, u, s) : ar(i, u),
              nr(i, u, l),
              (s = u || l || s),
              this.gradientManager.addWithoutUpdate(l, d),
          ...
          for (var f = 0; f < c.count; f++) {
            var d = a[c.indices[f]]
            ;(s = l = sr(d) || hr(d) || s),
              this.gradientManager.markUsed(d),
              this.gradientManager.addWithoutUpdate(l, d),
              this.clipPathManager.markUsed(d)
          }
      }
    ...
    _getDefs: function(t) {
      ...
      return 0 === i.length
        ? t
          ? ((i = e.insertBefore(Hi('defs'), e.firstChild)).contains ||
              (i.contains = function(t) {
                var e = i.children
                if (!e) return !1
                for (var r = e.length - 1; r >= 0; --r) if (e[r] === t) return !0
    ...
    _getSize: function(t) {
      ...
      var o = this.root,
        s = document.defaultView.getComputedStyle(o)
      return ((o[r] || er(s[i]) || er(o.style[i])) - (er(s[n]) || 0) - (er(s[a]) || 0)) | 0
    },
    dispose: function() {
    ...
    $e('svg', cs)
  var fs,
    ds = 'urn:schemas-microsoft-com:vml',
    ps = 'undefined' == typeof window ? null : window,
    vs = !1,
    gs = ps && ps.document
  if (gs && !mr.canvasSupported)
    try {
      !gs.namespaces.zrvml && gs.namespaces.add('zrvml', ds),
        (fs = function(t) {
          return gs.createElement('<zrvml:' + t + ' class="zrvml">')
        })
    } catch (t) {
      fs = function(t) {
        return gs.createElement('<' + t + ' xmlns="' + ds + '" class="zrvml">')
      }
    }
  var _s = Fa.CMD,
    ms = Math.round,
  ...
  if (!mr.canvasSupported) {
    var Ts = 21600,
      ...
      Bs = function(t, e, i) {
        ...
        ;(i = +i),
          isNaN(i) && (i = 1),
          r && ((t.color = Ss(r[0], r[1], r[2])), (t.opacity = i * r[3]))
      },
      Ds = function(t) {
        var e = ht(t)
        return [Ss(e[0], e[1], e[2]), e[3]]
      },
      Es = function(t, e, i) {
        var r = e.fill
        if (null != r)
          if (r instanceof jo) {
            ...
            for (var b = w.length, k = [], T = [], C = 0; C < b; C++) {
              var M = w[C],
                P = Ds(M.color)
              T.push(M.offset * h + s + ' ' + P[0]), (0 !== C && C !== b - 1) || k.push(P)
            }
            if (b >= 2) {
              var S = k[0][0],
                L = k[1][0],
          ...
          } else Bs(t, r, e.opacity)
      },
      Is = function(t, e) {
        null != e.lineDash && (t.dashstyle = e.lineDash.join(' ')),
          null == e.stroke || e.stroke instanceof jo || Bs(t, e.stroke, e.opacity)
      },
      Os = function(t, e, i, r) {
        var n = 'fill' == e,
        ...
        null != i[e] && 'none' !== i[e] && (n || (!n && i.lineWidth))
          ? ((t[n ? 'filled' : 'stroked'] = 'true'),
            i[e] instanceof jo && As(t, a),
            a || (a = ur(e)),
            n ? Es(a, i, r) : Is(a, i),
            Ls(t, a))
          : ((t[n ? 'filled' : 'stroked'] = 'false'), As(t, a))
      },
      Hs = [[], [], []],
      Fs = function(t, e) {
        var i,
        ...
        for (a = 0; a < v; ) {
          switch (((n = p[a++]), (r = ''), (i = 0), n)) {
            case h:
              ;(r = ' m '), (i = 1), (o = p[a++]), (s = p[a++]), (Hs[0][0] = o), (Hs[0][1] = s)
              break
            case u:
              ;(r = ' l '), (i = 1), (o = p[a++]), (s = p[a++]), (Hs[0][0] = o), (Hs[0][1] = s)
              break
            case f:
            case l:
              ;(r = ' c '), (i = 3)
            ...
            case c:
              ...
              e &&
                ...
                (C = ys(e[2] * e[2] + e[3] * e[3])),
                (M = Math.atan2(-e[1] / C, e[0] / T)))
              var P = p[a++],
                S = p[a++],
                L = p[a++],
                A = p[a++],
          ...
          if (i > 0) {
            ...
            for (var W = 0; W < i; W++) {
              var V = Hs[W]
              e && D(V, V, e),
                d.push(ms(V[0] * Ts - Cs), ',', ms(V[1] * Ts - Cs), W < i - 1 ? ',' : '')
            }
          }
        }
        return d.join('')
    ...
    ;(zi.prototype.brushVML = function(t) {
      var e = this.style,
        i = this._vmlEl
      i || ((i = ur('shape')), Ms(i), (this._vmlEl = i)),
        Os(i, 'fill', e, this),
        Os(i, 'stroke', e, this)
      ...
      var h = this.path || (this.path = new Fa())
      this.__dirtyPath &&
        (h.beginPath(), this.buildPath(h, this.shape), h.toStatic(), (this.__dirtyPath = !1)),
        (i.path = Fs(h, this.transform)),
      ...
      (zi.prototype.onRemove = function(t) {
        As(t, this._vmlEl), this.removeRectText(t)
      }),
      (zi.prototype.onAdd = function(t) {
        Ls(t, this._vmlEl), this.appendRectText(t)
      })
    var Ws = function(t) {
      return 'object' == typeof t && t.tagName && 'IMG' === t.tagName.toUpperCase()
    }
    ;(Se.prototype.brushVML = function(t) {
      var e,
        i,
        r = this.style,
        n = r.image
      ...
      if (n) {
        var l = r.x || 0,
          ...
          _ = d && p,
          m = this._vmlEl
        m || ((m = gs.createElement('div')), Ms(m), (this._vmlEl = m))
        var y,
          x = m.style,
          w = !1,
          b = 1,
        ...
        if (
          (this.transform &&
            ((y = this.transform),
            (b = ys(y[0] * y[0] + y[1] * y[1])),
            (k = ys(y[2] * y[2] + y[3] * y[3])),
            (w = y[1] || y[2])),
          w)
        ) {
          var T = [l, u],
            ...
            M = [l, u + f],
            P = [l + c, u + f]
          D(T, T, y), D(C, C, y), D(M, M, y), D(P, P, y)
          var S = ks(T[0], C[0], M[0], P[0]),
            L = ks(T[1], C[1], M[1], P[1]),
            A = []
          A.push(
            'M11=',
            y[0] / b,
            ...
            (x.padding = '0 ' + ms(S) + 'px ' + ms(L) + 'px 0'),
            (x.filter =
              'progid:DXImageTransform.Microsoft.Matrix(' + A.join('') + ', SizingMethod=clip)')
        } else
          y && ((l = l * b + y[4]), (u = u * k + y[5])),
            (x.filter = ''),
            (x.left = ms(l) + 'px'),
            (x.top = ms(u) + 'px')
        var z = this._imageEl,
          R = this._cropEl
        z || ((z = gs.createElement('div')), (this._imageEl = z))
        var B = z.style
        if (_) {
          if (e && i)
            (B.width = ms((b * e * c) / d) + 'px'), (B.height = ms((k * i * f) / p) + 'px')
          else {
            var E = new Image(),
              I = this
            ;(E.onload = function() {
              ;(E.onload = null),
                (e = E.width),
                (i = E.height),
                (B.width = ms((b * e * c) / d) + 'px'),
                (B.height = ms((k * i * f) / p) + 'px'),
                (I._imageWidth = e),
                (I._imageHeight = i),
                (I._imageSrc = n)
            }),
          ...
          R || (((R = gs.createElement('div')).style.overflow = 'hidden'), (this._cropEl = R))
          var O = R.style
          ;(O.width = ms((c + (v * c) / d) * b)),
            (O.height = ms((f + (g * f) / p) * k)),
            (O.filter =
              ...
              ((-g * f) / p) * k +
              ')'),
            R.parentNode || m.appendChild(R),
            z.parentNode != R && R.appendChild(z)
        } else
          (B.width = ms(b * c) + 'px'),
            (B.height = ms(k * f) + 'px'),
            m.appendChild(z),
            R && R.parentNode && (m.removeChild(R), (this._cropEl = null))
        var H = '',
          F = r.opacity
        F < 1 && (H += '.Alpha(opacity=' + ms(100 * F) + ') '),
          (H +=
            'progid:DXImageTransform.Microsoft.AlphaImageLoader(src=' +
            n +
            ', SizingMethod=scale)'),
          (B.filter = H),
          (m.style.zIndex = zs(this.zlevel, this.z, this.z2)),
          Ls(t, m),
          null != r.text && this.drawRectText(t, this.getBoundingRect())
      }
    }),
      (Se.prototype.onRemove = function(t) {
        As(t, this._vmlEl),
          (this._vmlEl = null),
          (this._cropEl = null),
          (this._imageEl = null),
    ...
    !(function(t, e) {
      ...
      var i = gs
      Vs ||
        (((Vs = i.createElement('div')).style.cssText =
          'position:absolute;top:-20000px;left:0;padding:0;margin:0;border:none;white-space:pre;'),
        gs.body.appendChild(Vs))
      try {
        Vs.style.font = e
      } catch (t) {}
      return (Vs.innerHTML = ''), Vs.appendChild(i.createTextNode(t)), { width: Vs.offsetWidth }
    })
    for (var Ys = new Pt(), Us = [qn, Pe, Se, zi, co], Gs = 0; Gs < Us.length; Gs++) {
      var Zs = Us[Gs].prototype
      ;(Zs.drawRectText = function(t, e, i, r) {
        var n = this.style
        this.__dirty && le(n)
        var a = n.text
        if ((null != a && (a += ''), a)) {
          ...
          var c,
            ...
            v = Xs(n.font),
            g = v.style + ' ' + v.variant + ' ' + v.weight + ' ' + v.size + 'px "' + v.family + '"'
          i = i || Yt(a, g, d, p)
          var _ = this.transform
          if ((_ && !r && (Ys.copy(e), Ys.applyTransform(_), (e = Ys)), r)) (c = e.x), (f = e.y)
          else {
            var m = n.textPosition,
              y = n.textDistance
            if (m instanceof Array)
              (c = e.x + Rs(m[0], e.width)), (f = e.y + Rs(m[1], e.height)), (d = d || 'left')
            else {
              var x = $t(m, e, y)
              ;(c = x.x), (f = x.y), (d = d || x.textAlign), (p = p || x.textVerticalAlign)
            }
          }
          ;(c = Zt(c, i.width, d)), (f = Qt(f, i.height, p)), (f += i.height / 2)
          var w,
            b,
            k,
            T = ur,
            C = this._textVmlEl
          C
            ? (b = (w = (k = C.firstChild).nextSibling).nextSibling)
            : ((C = T('line')),
              (w = T('path')),
              (b = T('textpath')),
              (k = T('skew')),
          ...
          _ && r
            ? (D(M, M, _),
              ...
              (k.matrix =
                ...
                _[3].toFixed(3) +
                ',0,0'),
              (k.offset = (ms(M[0]) || 0) + ',' + (ms(M[1]) || 0)),
              (k.origin = '0 0'),
              (P.left = '0px'),
              (P.top = '0px'))
            : ((k.on = !1), (P.left = ms(c) + 'px'), (P.top = ms(f) + 'px')),
            (b.string = Ps(a))
          try {
            b.style.font = g
          } catch (t) {}
          Os(C, 'fill', { fill: n.textFill, opacity: n.opacity }, this),
            Os(
              C,
              'stroke',
              { stroke: n.textStroke, opacity: n.opacity, lineDash: n.lineDash },
              this,
            ),
            (C.style.zIndex = zs(this.zlevel, this.z, this.z2)),
            Ls(t, C)
        }
      }),
        (Zs.removeRectText = function(t) {
          As(t, this._textVmlEl), (this._textVmlEl = null)
        }),
        (Zs.appendRectText = function(t) {
          Ls(t, this._textVmlEl)
        })
    }
    ;(co.prototype.brushVML = function(t) {
      var e = this.style
      null != e.text
        ? this.drawRectText(
            t,
      ...
      (co.prototype.onRemove = function(t) {
        this.removeRectText(t)
      }),
      (co.prototype.onAdd = function(t) {
  ...
  ;(dr.prototype = {
    ...
    _getWidth: function() {
      var t = this.root,
        e = t.currentStyle
      return ((t.clientWidth || fr(e.width)) - fr(e.paddingLeft) - fr(e.paddingRight)) | 0
    },
    _getHeight: function() {
      var t = this.root,
        e = t.currentStyle
      return ((t.clientHeight || fr(e.height)) - fr(e.paddingTop) - fr(e.paddingBottom)) | 0
    },
  }),
    u(
      [
    ...
    (t.dispose = function(t) {
      if (t) t.dispose()
        ...
        for (var e in oa) oa.hasOwnProperty(e) && oa[e].dispose()
        oa = {}
      }
      return this
    }),
